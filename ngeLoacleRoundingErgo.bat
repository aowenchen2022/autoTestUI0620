...
mvn clean integration-test -Dselenium.browser=Chrome %DEBUGINFO% -Dselenium.browser.buyer=Chrome -Dselenium.domain=sqa %LOCALE% -DtestngFile=testngLocaleRoundingErgo.xml
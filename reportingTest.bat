...
if "%%A" == "loop" set RUN_LIST=-DrunList=1,2,3,4,5

)

mvn clean integration-test %BROWSER% %DEBUGINFO% %BUYERBROWSER% %DOMAIN% %RUN_LIST% -DtestngFile=testngReporting.xml 
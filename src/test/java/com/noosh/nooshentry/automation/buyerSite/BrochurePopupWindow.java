...
public class BrochurePopupWindow extends Page
{
   ...
   @FindBy(xpath="brochurePopupWindow.complationDataCalendar")
   ...
   public void setNextMonth() {
	   nextMonth.click();
	   //next.findElement(By.className("ui-datepicker-next")).findElement(By.tagName("span")).click();
   }
   ...
   public void clickCreateBT() {  
	   if(!cpNextStep.isDisplayed()) {
		   throw new IllegalStateException("Create Project button is missing!");
	   } else 
	       cpNextStep.click();
   }

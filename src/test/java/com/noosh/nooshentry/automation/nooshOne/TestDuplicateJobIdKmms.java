...
public class TestDuplicateJobIdKmms extends BaseSeleniumTest {
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testSearchProject(String BuyberWorkGroupNmae) throws InterruptedException{
		
		driver.findElement(By.id("search/Keyword")).sendKeys("92098");
		Thread.sleep(2000);
		List<WebElement> imgs = driver.findElement(By.id("searchForm")).findElements(By.tagName("img"));
		imgs.get(1).click();
		Thread.sleep(2000);
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testCopyProject(String BuyberWorkGroupNmae) throws InterruptedException{
		
		driver.findElement(By.id("leftnav_home_copy")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("copyPorjectPage.specCheckbox")).click();
		Thread.sleep(1000);
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testCreateOrder(String BuyberWorkGroupNmae) throws Exception{
		
		driver.findElement(By.id("leftnav_buy_order_create")).click();
		Thread.sleep(2000);
		driver.findElement(By.linkText("Check All")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("create_quick_order")).click();
		Thread.sleep(1000);
		new Select(driver.findElement(By.name("order.reasonId"))).selectByIndex(1);
		...
		testSelectContact("Panisra Phungpho", supplierInput);
		Thread.sleep(1000);
        ...
        for (int i = 1; i < 20; i++) {
            ...
            String myId = "orderItem" + i +".unitPrice";
            driver.findElement(By.id(myId)).sendKeys("1");
    		Thread.sleep(500);
    		driver.findElement(By.id(myId)).sendKeys(Keys.TAB);
    		Thread.sleep(500);
            }
    	...
    	executor.executeScript("window.open('" + curURL + "')");
    	Thread.sleep(1000);
    		for (String toHandle : driver.getWindowHandles()) {
    			...
    			WebElement button = driver.findElement(By.id("confirm_order_creation"));
    	    	executor.executeScript("arguments[0].focus();", button);
    	    	button.sendKeys(Keys.ENTER);
    		}
    		//driver.close();
    		driver.switchTo().window(curHandle);
    		executor.executeScript("arguments[0].click();", driver.findElement(By.id("confirm_order_creation")));
		Thread.sleep(15000);
	...
	public void testCreateProjectWizard(String productName1,
		...
		//driver.findElement(By.name("@Purchase_Order_Contact_str")).sendKeys("TestContact");
	...
	public void testCreateSpecs2(String specName, String Quantity)
		...
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("template_5001052"))).selectByIndex(1);
		Thread.sleep(1000);
		driver.findElement(By.id("continue")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("quantity1")).sendKeys("19000");
		Thread.sleep(1000);
		driver.findElement(By.id("update_spec")).click();
		Thread.sleep(1000);
		copySpec();
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		brochurePopup.setComplationDate(); 
		WebElement supplierInput = driver.findElement(By.className("contactSelectorContainer")).findElement(By.tagName("input"));
		testSelectContact("Gino Andrie", supplierInput);
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
	...
	public void testQuoteCreate() throws Exception {
		...
		List<WebElement> tds = driver.findElement(By.className("total")).findElements(By.tagName("td"));
		driver.findElement(By.className("total")).findElement(By.tagName("input")).click();
		String[] eachXpath = {"newHomePage.totalPrice", "newHomePage.quantity1"};
		String[][] eachValue = getValueWithDifferentLoacle(eachXpath);
		Assert.assertEquals(eachValue[0][0], "€334.88");
		Assert.assertEquals(eachValue[1][0], "€334.88");
		Assert.assertEquals(eachValue[2][0], "334,88€");
		Assert.assertEquals(eachValue[3][0], "€334,88");
		Assert.assertEquals(eachValue[0][1], "19,000");
		Assert.assertEquals(eachValue[1][1], "19,000");
		Assert.assertEquals(eachValue[2][1], "19.000");
		Assert.assertEquals(eachValue[3][1], "19.000");
		driver.findElement(By.className("total")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("create")).click();
		Thread.sleep(1000);
		
		new Select(driver.findElement(By.id("@quote.erp_code_str"))).selectByIndex(1);
		...
		new Select(driver.findElement(By.id("@quote.markupKey_str"))).selectByValue("11.33");
		List<WebElement> buttons = driver.findElement(By.className("nplTable")).findElements(By.tagName("button"));
		//buttons.get(3).click();
		...
		Thread.sleep(1000);
		String[] quoteXpath = {"quotePage.sellPrice", "quotePage.rounding", "quotePage.uomPrice"};
		String[][] eachQuoteValue = getValueWithDifferentLoacle(quoteXpath);
		//System.out.print("eachQuoteValue"+Arrays.toString(eachQuoteValue));
		Assert.assertEquals(eachQuoteValue[0][0], "€372.97");
		Assert.assertEquals(eachQuoteValue[1][0], "€372.97");
		Assert.assertEquals(eachQuoteValue[2][0], "372,97€");
		Assert.assertEquals(eachQuoteValue[3][0], "€372,97");
		
		Assert.assertEquals(eachQuoteValue[0][1], "€0.15000");
		Assert.assertEquals(eachQuoteValue[1][1], "€0.15000");
		Assert.assertEquals(eachQuoteValue[2][1], "0,15000€");
		Assert.assertEquals(eachQuoteValue[3][1], "€0,15000");
		
		Assert.assertEquals(eachQuoteValue[0][2], "€0.01963");
		Assert.assertEquals(eachQuoteValue[1][2], "€0.01963");
		Assert.assertEquals(eachQuoteValue[2][2], "0,01963€");
		Assert.assertEquals(eachQuoteValue[3][2], "€0,01963");
	...
	@Test(description = "Outsourcer create quote - step 7")
	public void testGeneratePricing() throws Exception {
		HomePage homePage = new HomePage(driver);
		//homePage.clickEstfromRecent();
		driver.findElement(By.id("leftnav_sell_generate_pricing")).click();
		Thread.sleep(1000);
		List<WebElement> checkBox = driver.findElements(By.className("zebra"));
		Thread.sleep(1000);
		checkBox.get(1).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("continue")).click();
		new Select(driver.findElement(By.id("@order.erp_code_str"))).selectByIndex(1);
		new Select(driver.findElement(By.id("@order.SHIP_FROM_str"))).selectByIndex(1);
		new Select(driver.findElement(By.id("@order.SHIP_TO_str"))).selectByIndex(1);
		...
		new Select(driver.findElement(By.id("@quote.SHIP_FROM_str"))).selectByIndex(1);
		new Select(driver.findElement(By.id("@quote.SHIP_TO_str"))).selectByIndex(1);
		new Select(driver.findElement(By.id("@order.BT_CONTACT_NAME_str"))).selectByIndex(1);
		driver.findElement(By.id("INVOICE_NUMBER_ID")).findElement(By.tagName("input")).sendKeys("testInvoiceNo");
		CommonUtils commonUtils = new CommonUtils(driver);
		commonUtils.testChooseCalendar();
		BrochurePopupWindow brochurePopup = new BrochurePopupWindow(driver);
		Thread.sleep(2000);   	    
		...
		Thread.sleep(1000);
		Thread.sleep(1000);
		driver.findElement(By.id("quote.quoteItem1.quotePrice1.preMarkup")).click();
		//driver.findElement(By.id("quote.quoteItem1.quotePrice1.preMarkup")).clear();
        ((JavascriptExecutor) driver).executeScript("document.getElementById('quote.quoteItem1.quotePrice1.preMarkup').value='334.88'");

		driver.findElement(By.id("quote.quoteItem1.quotePrice1.preMarkup")).sendKeys("334.88");
        Thread.sleep(1000);
		driver.findElement(By.id("quote.quoteItem1.comments")).click();
		List <WebElement> buttons = driver.findElements(By.tagName("button"));
		buttons.get(7).click();
		Thread.sleep(10000);
/*
		driver.findElement(By.id("leftnav_quote_home")).click();
		Thread.sleep(1000);
		List<WebElement> quoteLnk = driver.findElement(By.className("nplTable")).findElements(By.tagName("a"));
		quoteLnk.get(1).click();
		Thread.sleep(1000);
		String[] quoteXpath = {"quotePage.sellPrice", "quotePage.rounding", "quotePage.uomPrice"};
		String[][] eachQuoteValue = getValueWithDifferentLoacle(quoteXpath);
		Assert.assertEquals(eachQuoteValue[0][0], "€375.25");
		Assert.assertEquals(eachQuoteValue[1][0], "€375.25");
		Assert.assertEquals(eachQuoteValue[2][0], "375,25€");
		Assert.assertEquals(eachQuoteValue[3][0], "€375,25");
		
		Assert.assertEquals(eachQuoteValue[0][1], "€0.18000");
		Assert.assertEquals(eachQuoteValue[1][1], "€0.18000");
		Assert.assertEquals(eachQuoteValue[2][1], "0,18000€");
		Assert.assertEquals(eachQuoteValue[3][1], "€0,18000");
		
		Assert.assertEquals(eachQuoteValue[0][2], "€0.01975");
		Assert.assertEquals(eachQuoteValue[1][2], "€0.01975");
		Assert.assertEquals(eachQuoteValue[2][2], "0,01975€");
		Assert.assertEquals(eachQuoteValue[3][2], "€0,01975");
		//System.out.print(Arrays.toString(eachQuoteValue));
		*/
		//String[] quoteXpath = {"quotePage.sellPrice", "quotePage.rounding", "quotePage.uomPrice"};
		//String[][] eachQuoteValue = getValueWithDifferentLoacle(quoteXpath);
		//System.out.println(eachQuoteValue);
		//driver.findElement(By.id("revise_quote")).click();
	...
	@Test(description = "Outsourcer create quote - step 7")
	public void testDirectQuoteCreate() throws Exception {
		HomePage homePage = new HomePage(driver);
		//homePage.clickEstfromRecent();
		driver.findElement(By.id("leftnav_quote_create")).click();
		Thread.sleep(1000);
		//driver.findElement(By.linkText("Check All")).click();
		Thread.sleep(1000);
		List <WebElement> checkbox = driver.findElements(By.className("zebra"));
        ...
        ((JavascriptExecutor) driver).executeScript("document.getElementById('quote.quoteItem1.quotePrice1.preMarkup').value='334.87887'");


		Thread.sleep(1000);

		//driver.findElement(By.id("quote.quoteItem2.quotePrice1.preMarkup")).sendKeys("334.88");
		...
		Thread.sleep(1000);
		List<WebElement> quoteLnk = driver.findElement(By.className("nplTable")).findElements(By.tagName("a"));
		quoteLnk.get(5).click();
		Thread.sleep(1000);
		String[] quoteXpath = {"quotePage.sellPrice", "quotePage.rounding", "quotePage.uomPrice"};
		String[][] eachQuoteValue = getValueWithDifferentLoacle(quoteXpath);
		Assert.assertEquals(eachQuoteValue[0][0], "€334.97");
		Assert.assertEquals(eachQuoteValue[1][0], "€334.97");
		Assert.assertEquals(eachQuoteValue[2][0], "334,97€");
		Assert.assertEquals(eachQuoteValue[3][0], "€334,97");
		
		Assert.assertEquals(eachQuoteValue[0][1], "€0.09000");
		Assert.assertEquals(eachQuoteValue[1][1], "€0.09000");
		Assert.assertEquals(eachQuoteValue[2][1], "0,09000€");
		Assert.assertEquals(eachQuoteValue[3][1], "€0,09000");
		
		Assert.assertEquals(eachQuoteValue[0][2], "€0.01763");
		Assert.assertEquals(eachQuoteValue[1][2], "€0.01763");
		Assert.assertEquals(eachQuoteValue[2][2], "0,01763€");
		Assert.assertEquals(eachQuoteValue[3][2], "€0,01763");
	...
	@Test(description = "Create order - step 8")
	public void testBuyOrderCreate() throws Exception {
		HomePage homePage = new HomePage(driver);
		driver.findElement(By.id("leftnav_quote_home")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("nplTable")).findElement(By.tagName("a")).click();
		...
		driver.findElement(By.id("confirm_order_creation")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("leftnav_buy_order_home")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("orders")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);
		String[] orderXpath = {"orderPage.grandTotal", "orderPage.orderTotal", "orderPage.itemPriceKmms"};
		String[][] eachOrderValue = getValueWithDifferentLoacle(orderXpath);
		Assert.assertEquals(eachOrderValue[0][0], "€334.88");
		Assert.assertEquals(eachOrderValue[1][0], "€334.88");
		Assert.assertEquals(eachOrderValue[2][0], "334,88€");
		Assert.assertEquals(eachOrderValue[3][0], "€334,88");
		
		Assert.assertEquals(eachOrderValue[0][1], "€334.88");
		Assert.assertEquals(eachOrderValue[1][1], "€334.88");
		Assert.assertEquals(eachOrderValue[2][1], "334,88€");
		Assert.assertEquals(eachOrderValue[3][1], "€334,88");
		
		Assert.assertEquals(eachOrderValue[0][2], "€334.88");
		Assert.assertEquals(eachOrderValue[1][2], "€334.88");
		Assert.assertEquals(eachOrderValue[2][2], "334,88€");
		Assert.assertEquals(eachOrderValue[3][2], "€334,88");
		//System.out.print("eachOrderValue"+Arrays.toString(eachOrderValue));
	...
	public void testChangeOrderCreate() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.id("span_itemIndex1_7")).findElement(By.tagName("input")).clear();
		driver.findElement(By.id("span_itemIndex1_7")).findElement(By.tagName("input")).sendKeys("434.87887");
		Thread.sleep(1000);
		driver.findElement(By.id("orderItem1.comments")).click();
		...
		driver.findElement(By.id("VIEW_ORDER_LIST")).click();
		Thread.sleep(3000);
		List<WebElement> orderlnk = driver.findElement(By.id("orders")).findElements(By.tagName("a"));
		orderlnk.get(1).click();
		Thread.sleep(1000);

		String[] changeOrderXpath = {"changeOrderPage.grandTotal", "changeOrderPage.orderTotal"};
		String[][] eachChangeOrderValue = getValueWithDifferentLoacle(changeOrderXpath);
		//System.out.print("eachChangeOrderValue"+Arrays.toString(eachChangeOrderValue));
		log.info("--------------------------------------------");
	}
	...
	public void testCloseChangeOrderCreate(String fileForProject11) throws Exception {
		Thread.sleep(2000);
		driver.findElement(By.id("MYDESK_PROJECT_ACTIVITY_body")).findElement(By.tagName("a")).click();
		Thread.sleep(1000);
		//driver.findElement(By.className("nplTable")).findElement(By.tagName("a")).click();
		...
		commonUtils.dealPotentialAlert(true);
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("@orderItem1.VAT_SELECTION_DD_str"))).selectByValue("9");
		Thread.sleep(1000);
		driver.findElement(By.id("invoice-1.ownerReference")).sendKeys("NO123");
		//driver.findElement(By.id("SEND_ON_CLOSED_ORDER_ID")).findElement(By.tagName("input")).click();
		//List<WebElement> tables = driver.findElements(By.className("alt"));
		//tables.get(6).findElement(By.tagName("input")).click();
		...
		//page.testAttachFile(fileForProject11);
		...
		Thread.sleep(3000);
		List<WebElement> orderlnk = driver.findElement(By.id("orders")).findElements(By.tagName("a"));
		orderlnk.get(2).click();
		Thread.sleep(1000);

		String[] closeChangeOrderXpath = {"closeChangeOrderPage.orderTotalKmms", "closeChangeOrderPage.taxKmms", "closeChangeOrderPage.grandTotalKmms"};
		String[][] eachCloseChangeOrderValue = getValueWithDifferentLoacle(closeChangeOrderXpath);
		Assert.assertEquals(eachCloseChangeOrderValue[0][0], "€0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[1][0], "€0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[2][0], "0,00€");
		Assert.assertEquals(eachCloseChangeOrderValue[3][0], "€0,00");
		
		Assert.assertEquals(eachCloseChangeOrderValue[0][1], "€39.14");
		Assert.assertEquals(eachCloseChangeOrderValue[1][1], "€39.14");
		Assert.assertEquals(eachCloseChangeOrderValue[2][1], "39,14€");
		Assert.assertEquals(eachCloseChangeOrderValue[3][1], "€39,14");
		
		Assert.assertEquals(eachCloseChangeOrderValue[0][2], "€39.14");
		Assert.assertEquals(eachCloseChangeOrderValue[1][2], "€39.14");
		Assert.assertEquals(eachCloseChangeOrderValue[2][2], "39,14€");
		Assert.assertEquals(eachCloseChangeOrderValue[3][2], "€39,14");
	...
	public void testOutsourcerInvoiceAcceptance() throws Exception {
		...
		driver.findElement(By.id("leftnav_buyInvoice")).click();
		Thread.sleep(2000);
		List <WebElement> tabs = driver.findElement(By.id("invoiceSection")).findElements(By.tagName("a"));
		tabs.get(1).click();
		Thread.sleep(1000);
		driver.findElement(By.className("alt1")).findElement(By.tagName("a")).click();
		Thread.sleep(1000);
    ...
    public static void copySpec() throws InterruptedException{
    	//Hover over My Desk>Summary> click on Switch workgroups
    	List <WebElement> cpSpec = driver.findElements(By.id("copy_spec"));
    	cpSpec.get(1).click();
    	Thread.sleep(1000);
    	driver.findElement(By.id("update_spec")).click();
    	Thread.sleep(2000);
    ...
    public static void switchDifferentLocale(String myLocale) throws InterruptedException{
    	String curHandle = driver.getWindowHandle();
		String loginPage = "https://" + domain + ".noosh.com/noosh/home/login";
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("window.open('" + loginPage + "')");
		Thread.sleep(1000);
		for (String toHandle : driver.getWindowHandles()) {
			if (toHandle.equals(curHandle)) {
			continue;
		...
		new Select(driver.findElement(By.name("locale"))).selectByValue(myLocale);
    ...
    public static  String[][] getValueWithDifferentLoacle(String[] myXpath) throws Exception{
    	String[] locales = {"en_US", "en_GB", "de_DE", "es_LA", locale};
    	String[][] Values = new String[locales.length][myXpath.length];
		...
		new Select(driver.findElement(By.name("locale"))).selectByValue(locales[i]);
		driver.navigate().refresh();
		Thread.sleep(2000);
		driver.close();
		driver.switchTo().window(curHandle);
		driver.navigate().refresh();
		Thread.sleep(2000);
		for (int j = 0; j < myXpath.length; j++) {
		WebElement myElement = driver.findElement(By.xpath(myXpath[j]));
		Values[i][j] = myElement.getText();
		if (Values[i][j] == null){
			Values[i][j] = myElement.getAttribute("value");
		}

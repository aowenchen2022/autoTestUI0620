...
public class TestInvoiceManager extends BaseSeleniumTest {
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindInvoice(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");

		List<WebElement> myProjectNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		invoiceName = myProjectNums.get(0).findElement(By.tagName("span")).getText();
		...
		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys(invoiceName);
		Thread.sleep(1000);
		List<WebElement> svg = driver.findElements(By.className("MuiSvgIcon-root"));
	  //  executor.executeScript("arguments[0].click();", svg.get(8));

		ManagerPage myManagerPage = new ManagerPage(driver);
		myManagerPage.clickSearchButton(2);
		Thread.sleep(5000);
		
		List<WebElement> projectNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String projectNum = projectNums.get(0).findElement(By.tagName("span")).getText();
		Assert.assertEquals(projectNum, invoiceName);
		...
		String projectNum2 = projectNums.get(3).getText();
		Assert.assertEquals(projectNum2, "5040299");
		...
		String projectNum3 = projectNums.get(3).getText();
		Assert.assertEquals(projectNum3, " 5115970 ");
*/
	...
	public void testSearchCreateDate(String specName, String Quantity)
		...
		List<WebElement> divs = driver.findElements(By.className("MuiOutlinedInput-root"));
		executor.executeScript("arguments[0].click();", divs.get(5));
		Thread.sleep(2000);
		List<WebElement> radios = driver.findElements(By.name("radioGroup"));
		executor.executeScript("arguments[0].click();", radios.get(1));
		Thread.sleep(2000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchInvoiceStatus(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
		...
		List<WebElement> invoiceNames = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String actualInvoiceName = invoiceNames.get(0).findElement(By.tagName("span")).getText();
		Assert.assertEquals(actualInvoiceName, invoiceName);
	}

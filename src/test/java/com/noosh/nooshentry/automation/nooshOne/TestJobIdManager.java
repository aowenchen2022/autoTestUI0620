...
public class TestJobIdManager extends BaseSeleniumTest {
	...
	public void testSearchFindJobId(String specName, String Quantity)
        ...
        Thread.sleep(1000);
        driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys(jobId);
		
		

        if (driver.findElement(By.className("Mui-checked")).isDisplayed()== true) {
	  ...
	  //  executor.executeScript("arguments[0].click();", svg.get(8));
		...
		Assert.assertEquals(projectNum, "Spec01");
		...
		List<WebElement> projectNums2 = driver.findElement(By.id("resultTable")).findElements(By.className("MuiTableRow-root"));
		String projectNum2 = projectNums2.get(1).findElement(By.tagName("a")).getText();
	//	Assert.assertEquals(projectNum2, "5050903-1");

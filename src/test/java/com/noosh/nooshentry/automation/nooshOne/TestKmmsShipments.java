...
public class TestKmmsShipments extends BaseSeleniumTest {
	...
	static String shipmentTemlateName = "00QA testing";
    ...
    public static void testGoToShipmentPage() throws InterruptedException{
		WebElement adminLink = driver.findElement(By.linkText("Admin"));
		Actions builder = new Actions(driver);
		builder.moveToElement(adminLink).perform();
		Thread.sleep(1500);
		builder.moveToElement(adminLink)
		.moveToElement(
				driver.findElement(By.linkText("My Group"))).click()
		.build().perform();
		Thread.sleep(2000);
	...
	@Test(description = "Create shipment template ")
	@Parameters({ "fileForProject11" })
    public void testErgoShipmentTemplate(String fileForProject11) throws InterruptedException, AWTException{
		testShipmentTemplate(fileForProject11);
	...
	@Test(description = "Create shipment template ")
	@Parameters({ "fileForProject11" })
    public void testKmmsShipmentTemplate(String fileForProject11) throws InterruptedException, AWTException{
		testShipmentTemplate(fileForProject11);
	}
    public void testShipmentTemplate(String fileForProject11) throws InterruptedException, AWTException{
	
    	testGoToShipmentPage();
    	/*
		if (driver.findElement(By.linkText(shipmentTemlateName)).isDisplayed() == true)
		{
		...
		*/
		...
		Thread.sleep(1000); 
		driver.findElement(By.id("shipment_-1_name")).sendKeys(shipmentTemlateName);
		driver.findElement(By.id("shipment_-1_comments")).sendKeys("myTestComments");
		Thread.sleep(1000); 
		driver.findElement(By.id("update")).click();
		Thread.sleep(1000); 
		driver.findElement(By.id("create")).click();
		Thread.sleep(1000); 
		driver.findElement(By.className("openPopup")).click();
		Thread.sleep(3000); 
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		driver.findElement(By.id("selectContacts")).click();
		Thread.sleep(1000); 
		...
		Thread.sleep(1000); 
		driver.findElement(By.id("nplSection_body")).findElement(By.tagName("input")).clear();
		driver.findElement(By.id("nplSection_body")).findElement(By.tagName("input")).sendKeys(shipmentTemlateName + "Edit");
		Thread.sleep(1000); 
		driver.findElement(By.id("update")).click();
		Thread.sleep(1000); 
		driver.findElement(By.id("requestId")).click();
		driver.findElement(By.id("edit")).click();
		Thread.sleep(1000); 
		driver.findElement(By.id("update")).click();
		Thread.sleep(1000); 
		...
		Thread.sleep(2000);		
		List<WebElement> saveButtons = driver.findElements(By.id("update"));

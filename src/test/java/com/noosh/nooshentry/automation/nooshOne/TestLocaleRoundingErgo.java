...
public class TestLocaleRoundingErgo extends BaseSeleniumTest {
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		new Select(driver.findElement(By.id("@rfe_0.suppliercategories_str"))).selectByValue("5067087");
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
	...
	public void testQuoteCreate() throws Exception {
		...
		System.out.print(Page.getXpath("newHomePage.totalPrice"));
		//WebElement totalPrice = driver.findElement(By.xpath("newHomePage.totalPrice"));
		//System.out.print(totalPrice);
		String[] eachXpath = {"newHomePage.totalPrice", "newHomePage.quantity1"};
		String[][] eachValue = getValueWithDifferentLoacle(eachXpath);
		Assert.assertEquals(eachValue[0][0], "$AUD334.88");
		Assert.assertEquals(eachValue[1][0], "$AUD334.88");
		Assert.assertEquals(eachValue[2][0], "334,88$AUD");
		Assert.assertEquals(eachValue[3][0], "$AUD334,88");
		...
		new Select(driver.findElement(By.id("@quote.markupKey_str"))).selectByValue("12");
...
//		buttons.get(4).click();
		...
		Assert.assertEquals(eachQuoteValue[0][0], "$AUD375.25");
		Assert.assertEquals(eachQuoteValue[1][0], "$AUD375.25");
		Assert.assertEquals(eachQuoteValue[2][0], "375,25$AUD");
		Assert.assertEquals(eachQuoteValue[3][0], "$AUD375,25");
		
		Assert.assertEquals(eachQuoteValue[0][1], "$AUD0.18000");
		Assert.assertEquals(eachQuoteValue[1][1], "$AUD0.18000");
		Assert.assertEquals(eachQuoteValue[2][1], "0,18000$AUD");
		Assert.assertEquals(eachQuoteValue[3][1], "$AUD0,18000");
		
		Assert.assertEquals(eachQuoteValue[0][2], "$AUD0.01975");
		Assert.assertEquals(eachQuoteValue[1][2], "$AUD0.01975");
		Assert.assertEquals(eachQuoteValue[2][2], "0,01975$AUD");
		Assert.assertEquals(eachQuoteValue[3][2], "$AUD0,01975");
...
//		driver.findElement(By.id("update_status")).click();
	...
	public void testDirectQuoteCreate() throws Exception {
		...
		driver.findElement(By.linkText("Check All")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("zebra")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("continue")).click();
		new Select(driver.findElement(By.id("@quote.erp_code_str"))).selectByIndex(1);
		new Select(driver.findElement(By.id("@quote.markupKey_str"))).selectByValue("12");
		...
		Thread.sleep(1000);
		driver.findElement(By.id("quote.quoteItem2.quotePrice1.preMarkup")).click();
		driver.findElement(By.id("quote.quoteItem2.quotePrice1.preMarkup")).clear();

		((JavascriptExecutor) driver).executeScript("document.getElementById('quote.quoteItem2.quotePrice1.preMarkup').value='334.88'");
...
//		driver.findElement(By.className("nplTable")).findElement(By.tagName("button")).click();
		...
		driver.findElement(By.id("quote.quoteItem2.quotedIndexId")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("send_quote")).click();
		Thread.sleep(2000);
	...
	public void testBuyOrderCreate() throws Exception {
		...
		driver.findElement(By.className("nplTable")).findElement(By.tagName("a")).click();
		Thread.sleep(1000);
		driver.findElement(By.name("leftnav_sell_generate_pricing")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("quoteId")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("selectSpec_body")).findElement(By.tagName("button")).click();
		Thread.sleep(4000);
		driver.findElement(By.id("quoteCreate_body")).findElement(By.tagName("button")).click();
		Thread.sleep(10000);
/*
		...
		Thread.sleep(3000);
		String[] orderXpath = {"orderPage.grandTotal", "orderPage.orderTotal", "orderPage.tax"};
		String[][] eachOrderValue = getValueWithDifferentLoacle(orderXpath);
		Assert.assertEquals(eachOrderValue[0][0], "$AUD368.37");
		Assert.assertEquals(eachOrderValue[1][0], "$AUD368.37");
		Assert.assertEquals(eachOrderValue[2][0], "368,37$AUD");
		Assert.assertEquals(eachOrderValue[3][0], "$AUD368,37");
		
		Assert.assertEquals(eachOrderValue[0][1], "$AUD334.88");
		Assert.assertEquals(eachOrderValue[1][1], "$AUD334.88");
		Assert.assertEquals(eachOrderValue[2][1], "334,88$AUD");
		Assert.assertEquals(eachOrderValue[3][1], "$AUD334,88");
		
		Assert.assertEquals(eachOrderValue[0][2], "$AUD33.49");
		Assert.assertEquals(eachOrderValue[1][2], "$AUD33.49");
		Assert.assertEquals(eachOrderValue[2][2], "33,49$AUD");
		Assert.assertEquals(eachOrderValue[3][2], "$AUD33,49");
	...
	public void testChangeOrderCreate() throws Exception {
		...
		String[] changeOrderXpath = {"changeOrderPage.grandTotal", "changeOrderPage.orderTotal", "changeOrderPage.tax"};
	...
	public void testCloseChangeOrderCreate() throws Exception {
		...
		String[] closeChangeOrderXpath = {"closeChangeOrderPage.orderTotal", "closeChangeOrderPage.tax", "closeChangeOrderPage.grandTotal"};
		String[][] eachCloseChangeOrderValue = getValueWithDifferentLoacle(closeChangeOrderXpath);
		Assert.assertEquals(eachCloseChangeOrderValue[0][0], "$AUD0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[1][0], "$AUD0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[2][0], "0,00$AUD");
		Assert.assertEquals(eachCloseChangeOrderValue[3][0], "$AUD0,00");
		
		Assert.assertEquals(eachCloseChangeOrderValue[0][1], "$AUD0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[1][1], "$AUD0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[2][1], "0,00$AUD");
		Assert.assertEquals(eachCloseChangeOrderValue[3][1], "$AUD0,00");
		
		Assert.assertEquals(eachCloseChangeOrderValue[0][2], "$AUD0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[1][2], "$AUD0.00");
		Assert.assertEquals(eachCloseChangeOrderValue[2][2], "0,00$AUD");
		Assert.assertEquals(eachCloseChangeOrderValue[3][2], "$AUD0,00");

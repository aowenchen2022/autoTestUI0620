...
public class TestMessage extends BaseSeleniumTest {
	...
	@Test(description = "Member1 login")
	@Parameters({ "Member1LoginN", "BuyerPassword" })
	public void testMember1Loginagain(String Member1LoginN, String BuyerPassword)
			throws InterruptedException {
		testBuyerLogin(Member1LoginN, BuyerPassword);
	}
	...
	public void testMember2Loginagain(String Member2LoginN, String BuyerPassword)
			throws InterruptedException {
		testBuyerLogin(Member2LoginN, BuyerPassword);
	}
	...
	@Test(description = "Existing Buyer Invite Suppliers - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testExistingBuyerInviteSuppliers()
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");

		ProjectMenu projectMenu = new ProjectMenu(driver);
		projectMenu.clickTeamsLnk();
		Thread.sleep(2000);
		projectMenu.clickInviteSuppliersLnk();
		Thread.sleep(1000);
		driver.findElement(By.className("personPickerTab")).click();
		Thread.sleep(2000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		List<WebElement> suppliers = driver.findElements(By.name("selectContacts"));
		suppliers.get(7).click();
		suppliers.get(9).click();
		Thread.sleep(1000);
		...
		log.info("End: testExistingSP Invite Suppliers");
		log.info("--------------------------------------------");
	}
	
	@Test(description = "Existing Buyer Invite Members - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testExistingOutsourcerInviteMembers()
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		...
		projectMenu.clickTeamsLnk();
		Thread.sleep(2000);
		projectMenu.clickInviteMembersLnk();
		Thread.sleep(1000);
		driver.findElement(By.className("personPickerTab")).click();
		Thread.sleep(2000);
		for (String handle : driver.getWindowHandles()) {
		...
		Thread.sleep(10000);
		log.info("End: testExistingSP Invite Members");
		log.info("--------------------------------------------");
	}
	...
	public void testExistingBuyerCreateRFE(String specName, String Quantity)
		...
		Thread.sleep(5000);
		Inputs.get(13).sendKeys("100");
		Inputs.get(21).clear();
		Inputs.get(21).sendKeys("200");
	...
	public void testBuyerCreateMSG() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.name("subject")).sendKeys("test Message1");
		driver.findElement(By.name("content")).sendKeys("test Message1");
		Thread.sleep(1000);
		//driver.findElement(By.name("post_all")).click();
		List<WebElement> checkBoxes = driver.findElements(By.id("dummy"));
	...
	@Test(description = "Buyer create Message - step 11")
	public void testOutsourcerCreateMSG() throws InterruptedException {
		ProjectMenu projectMenu = new ProjectMenu(driver);
		projectMenu.clickMessageLink();
		Thread.sleep(1000);
		driver.findElement(By.id("create_message")).click();
	...
	@Test(description = "Supplier reply Message - step 11-2")
	public void testReplyAllMSG() throws Exception {
		WebElement MSGlnk = driver.findElement(By
				.className("glb-wdgt-msg-line-content"));
		List<WebElement> replyButtons = driver.findElement(By.className("message-actions"))
				.findElements(By.className("glb-button"));
		
		Actions builder = new Actions(driver);
		Thread.sleep(1000);
		//builder.moveToElement(MSGlnk).perform();
		builder.moveToElement(MSGlnk)
				.moveToElement(replyButtons.get(1))
				.click().perform();
		Thread.sleep(1000);
		//builder.moveToElement(MSGlnk).perform();
		builder.moveToElement(MSGlnk)
		.moveToElement(
				driver.findElement(By.className("message-actions"))
						.findElement(By.className("ng-pristine"))).click()
		.sendKeys("Rely from Member1").perform();
		Thread.sleep(1000);
		builder.moveToElement(MSGlnk)
				.moveToElement(
						driver.findElement(By.className("message-actions"))
	...
	@Test(description = "Supplier login")
	@Parameters({ "supplierUserName2", "passwd" })
	public void testMSGSupplier2Login(String supplierUserName, String passwd)
			throws InterruptedException {
		testSupplierLogin(supplierUserName, passwd);
	}

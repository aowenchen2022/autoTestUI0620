...
public class TestNewProjectHome extends BaseSeleniumTest {
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		testSelectContact("f_sunitmgr1s5", supplierInput);
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
	...
	public void testQuoteCreate() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.className("glb-wdgt-estimates-project")).click();
		Thread.sleep(2000);
...
*/
	...
	public void testCloseChangeOrderCreate() throws Exception {
		...
		driver.findElement(By.linkText("Home")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("wdgt-overview-order-type")).click();
		Thread.sleep(1000);

...
public class TestNgeNpNooshoneSSO extends BaseSeleniumTest {  
   ...
   String myLoginName = "selenium" + unicID;
   ...
   public static void setParameters(ITestContext context) throws FileNotFoundException {
	   if (domain.trim().equals("spd")) {
		   ...
		   baseUrlSmoke = "http://amber." + domain + "." + "noosh" + ".com/service/login";
   ...
   public void testLoginPage(String loginSQANoosh, String passwordSP) throws InterruptedException {
	...
	public void testCheckWGpreferences(String AdminLoginN, String AdminPassword, String BuyberWorkGroupNmae, String SupplierWorkGroupNmae)
		...
		Thread.sleep(2000);
		List<WebElement> tds = driver.findElement(By.className("alt2")).findElements(By.tagName("a"));
		tds.get(1).click();
		Thread.sleep(3000);
		...
		Thread.sleep(1000);
		WebElement dcCheckBox = driver.findElement(By.id("workgroupOptionNooshOneUI"));
	...
	//	clickCheckBox(ssCheckBox, true);
		...
		Thread.sleep(2000);
		driver.findElement(By.linkText("NGE Settings")).click();
		Thread.sleep(5000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		driver.switchTo().frame("ngeSettingsIframeView");
		List<WebElement> Inputs = driver.findElements(By.tagName("input"));
		Thread.sleep(5000);
		// driver.findElement(By.tagName("input"));
		Inputs.get(2).clear();
		Thread.sleep(1000);
		Inputs.get(2).sendKeys("Amber");
		//Inputs.get(10).sendKeys("200");
		WebElement dashboardCheckBox = driver.findElement(By.id("WORKGROUP_OPTION_NL_SITE_MANAGER"));
		clickCheckBox(dashboardCheckBox, true);
		Thread.sleep(1000);
	...
	public void testInviteTeamMembers(String specName, String Quantity)
		...
		Thread.sleep(1000);
		driver.findElement(By.id("firstName")).sendKeys("F_SUNITMEM1S3");
		Thread.sleep(1000);
		driver.findElement(By.id("lastName")).sendKeys("L_SUNITMEM1S3");
		Thread.sleep(1000);
		driver.findElement(By.id("emailAddress")).sendKeys("sunit@noosh.com");
		Thread.sleep(1000);
		driver.findElement(By.id("save")).click();
		Thread.sleep(1000);
		driver.findElement(By.name("invitee")).findElement(By.id("invite_this_person")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("internalMemberPage.activateButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("loginName")).sendKeys(myLoginName);
		Thread.sleep(1000);
		driver.findElement(By.id("displayPassword")).sendKeys("Noosh123");
		Thread.sleep(1000);
		driver.findElement(By.id("displayReEnterPassword")).sendKeys("Noosh123");
		Thread.sleep(1000);
	  ...
	  @Test(description="SSO-1, Go to Noosh Entry through sites menu")
	   ...
	   public void testWorkSpaceCheck(String myDeskPage, String profileTitlePro) throws Exception {    
   ...
   public void testMyDeskPageBack(String myDeskPage) throws InterruptedException {
	  ...
	  driver.findElement(By.className("glb-header-menu-dropdown-wrap")).click();     
	  Thread.sleep(1000);  
	  for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
	  driver.findElement(By.id("glbMyDeskDropdownHref")).findElement(By.tagName("div")).click();
      Thread.sleep(5500);
   ...
   public void testLoginDemoSqaPageSmoke(String passwordSP, String spEmailSmoke) throws InterruptedException {
	   ...
	   loginDemoSqa.loginUser(myLoginName, passwordSP);   
	   Thread.sleep(2000);
	   spSiteLoginPage = driver.getCurrentUrl();	

...
public class TestOrderManager extends BaseSeleniumTest {
	...
	public void testSearchFindOrder(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys(orderName);
		Thread.sleep(1000);

...
public class TestPrintAcuity extends BaseSeleniumTest {
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testSwitchWorkGroupsAgain(String BuyberWorkGroupNmae) throws InterruptedException{
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		driver.findElement(By.name("rfe_0.title")).click();
		Thread.sleep(1000);
		driver.findElement(By.name("rfe_0.title")).sendKeys(rfeName);
		Thread.sleep(2000);
		...
		testSelectContact("Andrew Ritchie", supplierInput);
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
	...
	@Test
	@Parameters({"gmailLoginPW", "validSPEmail"})
	public void testSupplierNotificationAgain(String gmailLoginPW, String validSPEmail) throws InterruptedException {
	    driver.get("http://www.gmail.com");
	  	Thread.sleep(2000);
	...
	@Test
	public void testSupplierCheckRfeEmail() throws InterruptedException {
	    log.info("Start: testSupplierCheckRfeEmail");
	    Thread.sleep(5000);
	    List<WebElement> emails = driver.findElements(By.tagName("span"));
	    for (WebElement email : emails) {
	    		if (email != null) {
	    			String emailTitle = email.getText();
	    			if (emailTitle.indexOf("Request for Estimate " + rfeName) >= 0) {
	    				email.click();
	    				break;
	    			}
	    		}
	    	...
	    	Thread.sleep(2500); 
	    	WebElement acceptInv = driver.findElement(By.linkText("Click Here"));
	    	...
	    	Thread.sleep(2500);  
	    	log.info("End: testSupplierCheckRfeEmail");
	    	log.info("--------------------------------------------");
	    }	
	
	@Test
	public void testSupplierCheckMessageEmail() throws InterruptedException {
	    log.info("Start: testSupplierCheckRfeEmail");
	    Thread.sleep(5000);
	    List<WebElement> emails = driver.findElements(By.tagName("span"));
	    for (WebElement email : emails) {
	    		if (email != null) {
	    			String emailTitle = email.getText();
	    			if (emailTitle.indexOf("(test Subject) posted regarding " + projectName) >= 0) {
	    				email.click();
	    				break;
	    			}
	    		}
	    	...
	    	Thread.sleep(2500); 
	    	WebElement acceptInv = driver.findElement(By.linkText(projName + " - test Subject"));
	    	if(!acceptInv.isDisplayed()) {
	    		throw new IllegalStateException("The accept invitation link is missing!");
	    	} else {
	    		acceptInv.click();
	...
	public void testPrintAcuity(String supplierUserName, String AdminPassword)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(1500);
		driver.get("https://vv-cd.printacuity.veritivcorp.com/");
		driver.manage().window().maximize();
		Thread.sleep(4000);
	...
	@Test(description = "Supplier login")
	@Parameters({ "supplierUserName", "AdminPassword" })
	public void testSupplierLoginAfterGmail(String supplierUserName, String AdminPassword)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(4000);
		for (String handle : driver.getWindowHandles()) {
	...
	@Test(description = "Supplier login")
	@Parameters({ "supplierUserName", "AdminPassword" })
	public void testSupplierLoginAfterGmailAgain(String supplierUserName, String AdminPassword)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(4000);
		for (String handle : driver.getWindowHandles()) {
		...
		testSupplierLoginAfterGmail(supplierUserName, AdminPassword);
		log.info("End: testSupplierLogin");
		log.info("--------------------------------------------");
	}
	...
	@Test(description = "Supplier login")
	@Parameters({ "supplierUserName", "AdminPassword" })
	public void testSupplierCheckIfRfeList(String supplierUserName, String AdminPassword)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(2000);
		driver.findElement(By.id("rfeSection_body")).findElement(By.tagName("a")).click();;
		Thread.sleep(2000);
	...
	@Test(description = "Supplier login")
	@Parameters({ "supplierUserName", "AdminPassword" })
	public void testSupplierCheckMessage(String supplierUserName, String AdminPassword)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(2000);
		driver.findElement(By.name("post_reply")).click();;
		Thread.sleep(2000);
		driver.findElement(By.name("topnav_logout")).click();
		Thread.sleep(5000);
		log.info("End: testSupplierLogin");
	...
	@Test(description = "Create order - step 8")
	public void testBuyQuickOrderCreate() throws Exception {
		HomePage homePage = new HomePage(driver);
		//driver.findElement(By.className("nplTable")).findElement(By.tagName("a")).click();
		//homePage.clickEstfromRecent();
		...
		driver.findElement(By.id("orderItem1.quantity")).sendKeys("1000");
		Thread.sleep(1000);
		driver.findElement(By.id("proceed_to_confirmation")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("confirm_order_creation")).click();
	...
	public void testBuyPaperOrderCreate() throws Exception {
		List<WebElement> links = driver.findElement(By.id("orders")).findElements(By.tagName("a"));
		links.get(1).click();
		Thread.sleep(1000);
	...
	@Test(description = "Create order - step 8")
	public void testBuyCancelOrder() throws Exception {
		List<WebElement> links = driver.findElement(By.id("orders")).findElements(By.tagName("a"));
		links.get(1).click();
		Thread.sleep(1000);
		driver.findElement(By.id("cancel_order")).click();
		Thread.sleep(1000);
		CommonUtils commonUtils = new CommonUtils(driver);
	...
	@Test(description = "Create order - step 8")
	public void testPaperOrderAutoCancel() throws Exception {
		List<WebElement> trs = driver.findElement(By.id("orders")).findElements(By.tagName("tr"));
		List<WebElement> tds = trs.get(9).findElements(By.tagName("td"));
		String status = tds.get(3).getText();
		System.out.print(status);
		...
		case "en_EU":
			...
			break;
		case "de_DE":
			Assert.assertEquals(status, "Abgebrochen");	
			break;
		case "es_LA":
			Assert.assertEquals(status, "Cancelado");	
			break;
	    }
	...
	@Parameters({ "SupplierWorkGroupNmae"})
	public  void testSupplierOrderEdit(String SupplierWorkGroupNmae) throws Exception {
		

		HomePage homePage = new HomePage(driver);
		homePage.clickReviewOrder(locale);
		Thread.sleep(1500);
		driver.findElement(By.id("edit_order")).click();
		Thread.sleep(1000);
		List<WebElement> selects = driver.findElements(By.tagName("select"));
		new Select(selects.get(5)).selectByIndex(1);
		Thread.sleep(1000);
		new Select(selects.get(6)).selectByIndex(1);
		Thread.sleep(1000);
		driver.findElement(By.className("qty")).sendKeys("1000");
		Thread.sleep(1000);
	...
	@Test(description = "Supplier accepts order - step 9")
	@Parameters({ "SupplierWorkGroupNmae"})
	public  void testOutsourcerOrderAcceptance(String SupplierWorkGroupNmae) throws Exception {
	...
	@Parameters({ "validSPEmail" })
	public void testSupplierChangeMail(String validSPEmail) throws InterruptedException {
		log.info("Start: testCheckGmail");
		Thread.sleep(5000);
		driver.findElement(By.linkText("Admin")).click();
		Thread.sleep(2000);
		List<WebElement> editBtn = driver.findElements(By.id("edit"));
		editBtn.get(2).click();
		Thread.sleep(2000);
		driver.findElement(By.id("emailAddress")).click();
		driver.findElement(By.id("emailAddress")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("emailAddress")).sendKeys(validSPEmail);
		Thread.sleep(1000);
	...
	@Test(description = "Supplier Check Gmail")
	@Parameters({ "email3" })
	public void testBuyerChangeMail(String email3) throws InterruptedException {
		log.info("Start: testCheckGmail");
		Thread.sleep(5000);
		driver.findElement(By.linkText("Admin")).click();
		Thread.sleep(2000);
		...
		driver.findElement(By.id("emailAddress")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("emailAddress")).sendKeys(email3);
		Thread.sleep(1000);
		driver.findElement(By.id("phoneNumber")).click();
		driver.findElement(By.id("phoneNumber")).clear();
		Thread.sleep(1000);
	...
	public void testCreateMSG() throws InterruptedException {
		projName = driver.findElement(By.id("MYDESK_PROJECT_ACTIVITY_body")).findElement(By.tagName("a")).getText();
		driver.findElement(By.id("MYDESK_PROJECT_ACTIVITY_body")).findElement(By.tagName("a")).click();
		driver.findElement(By.id("leftnav_message_post")).click();
		Thread.sleep(1000);

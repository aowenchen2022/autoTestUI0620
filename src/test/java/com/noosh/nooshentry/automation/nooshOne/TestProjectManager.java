...
public class TestProjectManager extends BaseSeleniumTest {
	...
	static String projectName="5150588";
	...
	public void testSearchFindBox(String specName, String Quantity)
     ...
     /* 
		...
		Assert.assertEquals(projectNum2, " 5117077 ");
		...
		Assert.assertEquals(projectNum3, " 5117077 ");
*/

...
public class TestQuoteManager extends BaseSeleniumTest {
	...
	public void testSearchFindBox(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys(quoteId);
		Thread.sleep(1000);

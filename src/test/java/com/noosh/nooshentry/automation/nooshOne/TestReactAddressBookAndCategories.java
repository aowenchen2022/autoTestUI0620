...
public class TestReactAddressBookAndCategories extends BaseSeleniumTest {
	...
	public void testPrintIcon(String specName, String Quantity)
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("addressBookPage.caretIcon")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("addressBookPage.caretIcon")).click();
		Thread.sleep(1000);
		...
		((JavascriptExecutor)driver).executeAsyncScript(
		    ...
		    "arguments[0].click();"
		    , driver.findElement(By.className("fa-print")));
		Thread.sleep(3000);
	...
	public void testSearchFindBox(String specName, String Quantity)
        ...
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiOutlinedInput-root")));
		
		Thread.sleep(1000);

		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys("Dgs1g1 mgr1");
		Thread.sleep(1000);
	...
	public void testEditNooshContacts(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys("Biedermann GmbH");
		Thread.sleep(1000);
		List<WebElement> dropDown = driver.findElements(By.className("MuiSelect-select"));
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", dropDown.get(1));

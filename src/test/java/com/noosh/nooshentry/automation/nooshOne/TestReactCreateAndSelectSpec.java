...
public class TestReactCreateAndSelectSpec extends BaseSeleniumTest {
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testCreateSpecsTemplate(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;
		MyGroup();
		driver.findElement(By.linkText("Spec Templates")).click();
		Thread.sleep(1000);
		try{
		if (checkElement(driver.findElement(By.linkText("testSpecTemplate")))){
			driver.findElement(By.xpath("specTemplatePage.deleteIcon")).click();
			Thread.sleep(1000);
			CommonUtils commonUtils = new CommonUtils(driver);
		...
		driver.findElement(By.id("create_spec_template")).click();
		Thread.sleep(1000);
		List <WebElement> radio = driver.findElements(By.name("typeId"));
		radio.get(6).click();
		Thread.sleep(1000);
		driver.findElement(By.id("continue")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		driver.findElement(By.id("name")).sendKeys("testSpecTemplate");
		Thread.sleep(1000);
		driver.findElement(By.id("save_spec_template")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("view_spec_template_list")).click();
		Thread.sleep(1000);
		log.info("End: testCreateSpec");
	...
	@Test(description = "Create Spec - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testViewSelectSpecForm(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;
		...
		Thread.sleep(2000);
		List <WebElement> workgropOptions = driver.findElements(By.className("MuiOutlinedInput-marginDense"));
		workgropOptions.get(1).click();
		Thread.sleep(1000);
		List <WebElement> options = driver.findElement(By.className("MuiMenu-list")).findElements(By.tagName("li"));
		options.get(1).click();
		Thread.sleep(2000);
		workgropOptions.get(1).click();
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("specTemplatePage.blankTemplate")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("specTemplatePage.selectTemplate")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("specTemplatePage.cancelButton")).click();
		Thread.sleep(2000);
	...
	@Parameters({ "memberUserName", "AdminPassword" })
	public void testMemberLogin(String memberUserName, String AdminPassword)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(1500);
		driver.get(baseUrl);
		...
		Thread.sleep(2000);
		LoginPage loginPage = new LoginPage(driver);
		loginPage.loginUser(memberUserName, AdminPassword);
		// spSiteLoginPage = driver.getCurrentUrl();
	...
	public void testSellOrderCreate() throws InterruptedException {
		//HomePage homePage = new HomePage(driver);
		//homePage.clickEstfromRecent();
		driver.findElement(By.xpath("quotePage.quoteLink")).click();
		Thread.sleep(2000);
		...
		AssertJUnit.assertEquals(totalMarkup, "$110.000");
		Thread.sleep(1000); 
	...
	@Test(description = "Create order - step 8")
	public void testCreateProposalFromQuote() throws InterruptedException {
		HomePage homePage = new HomePage(driver);
		//driver.findElement(By.className("nplTable")).findElement(By.tagName("a")).click();
		Thread.sleep(2000);
		driver.findElement(By.className("glb-wdgt-quote-list-quotes")).findElement(By.tagName("a")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("goto_create_proposal")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("qSelect_body")).findElement(By.tagName("button")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("save")).click();
		Thread.sleep(5000);
		String status = driver.findElement(By.className("nplTable")).findElement(By.tagName("table")).findElement(By.tagName("b")).getText();
		AssertJUnit.assertEquals(status, "Draft");
		Thread.sleep(1000); 
	...
	public void testDefaultOrderSummary () throws Exception {
		...
		Thread.sleep(2000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "$0.000");
		Thread.sleep(1000); 
	...
	public void testCreateBuyOrder() throws Exception {
		...
		Thread.sleep(1000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "-$1,000.000");
		Thread.sleep(1000); 
...
*/
	...
	public void testChangeOrderCreate() throws Exception {
		...
		Thread.sleep(3000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "-$1,100.000");
		Thread.sleep(1000); 
	...
	public void testSellChangeOrderCreate() throws Exception {
		...
		Thread.sleep(3000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "$210.000");
		Thread.sleep(1000); 
	...
	@Test(description = "Create Spec - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testCreateRfq(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;
		Actions builder = new Actions(driver);		
		...
		Thread.sleep(1500);
		builder.moveToElement(driver.findElement(By.xpath("newHomePage.createRfqButton"))).click().perform();
		Thread.sleep(1000);
		driver.findElement(By.linkText("Check All")).click();
		List <WebElement> continueButtons = driver.findElements(By.id("continue"));
		...
		BrochurePopupWindow brochurePopup = new BrochurePopupWindow(driver);
		Thread.sleep(2000);   	    
		List <WebElement> canlendars = driver.findElements(By.id("open_calendar"));
		canlendars.get(1).click();
		Thread.sleep(1000); 
		brochurePopup.setNextMonth();
		Thread.sleep(1000); 
		brochurePopup.setComplationDate(); 
		...
		testSelectContact("karan", userInput);
		Thread.sleep(1000);
		driver.findElement(By.id("send_rfq")).click();
		Thread.sleep(4000);
		log.info("End: testCreateSpec");
	...
	public void testCreateQuote(String specName, String Quantity)
		...
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;
		driver.findElement(By.className("glb-wdgt-rfqs-project-rfqs")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);
...
/*
	...
	public void testCreateTask() throws Exception {
	 ...
	 public static void MyGroup() throws InterruptedException {	 
		 WebElement topMenu = driver.findElement(By.className("glb-nmh-profile"));
		 topMenu.click();
		 Thread.sleep(1000);
		 Actions builder = new Actions(driver);
		 builder.moveToElement(topMenu).moveToElement(driver.findElement(By.linkText("My Group"))).click().perform();
		 Thread.sleep(3500);
	 }

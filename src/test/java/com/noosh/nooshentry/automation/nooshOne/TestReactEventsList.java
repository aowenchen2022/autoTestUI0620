...
public class TestReactEventsList extends BaseSeleniumTest {
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		Thread.sleep(1000); 
		driver.findElement(By.xpath("rfePage.calendarNextButton")).click();
		Thread.sleep(1000); 
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].click();",driver.findElement(By.xpath("searchManagerPage.calendarNum")));
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		driver.findElement(By.xpath("rfePage.calendarButton2")).click();
		Thread.sleep(1000); 
		driver.findElement(By.xpath("rfePage.calendarNextButton")).click();
		Thread.sleep(2000);
		((JavascriptExecutor) driver).executeScript("arguments[0].click();",driver.findElement(By.xpath("searchManagerPage.calendarNum2")));
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		...
		Actions builder = new Actions(driver);
		Thread.sleep(1500);
		builder.moveToElement(driver.findElement(By.xpath("rfePage.contactsLink"))).click().perform();
	...
	public void testSupplierEstCreate() throws InterruptedException, AWTException {
		...
		Thread.sleep(1000);
		nobrs.get(3).findElement(By.tagName("input")).sendKeys("300");
		nobrs.get(3).findElement(By.tagName("input")).sendKeys("{Tab}");
	...
	@Test(description = "Supplier create estimate - step 6")
	public void testSupplierFilterCriteria() throws InterruptedException, AWTException {
		String estRefNo;
		//projectName =  "Selenium198183";
		...
		driver.findElement(By.className("MuiFormControl-fullWidth")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-fullWidth")).findElement(By.tagName("input")).sendKeys("estimate");
		Thread.sleep(1000);
		driver.findElement(By.xpath("eventPage.searchButton")).click();
		Thread.sleep(1000);

		List<WebElement> eventObjects = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("p"));
		String eventObject = eventObjects.get(0).getText();
		AssertJUnit.assertEquals(eventObject, "Dgs1g1 mgr1");
		
		log.info("--------------------------------------------");
	}
	
	@Test(description = "Supplier create estimate - step 6")
	public void testSupplierTriggeredDate() throws InterruptedException, AWTException {
		String estRefNo;
		//projectName =  "Selenium198183";
		List<WebElement> inputs = driver.findElements(By.className("MuiOutlinedInput-inputMarginDense"));
		inputs.get(1).click();
	...
	@Test(description = "Supplier create estimate - step 6")
	public void testSupplierCreateEvent() throws InterruptedException, AWTException {
		String estRefNo;
		//projectName =  "Selenium198183";

		driver.findElement(By.xpath("eventPage.createEventButton")).click();
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("TR_TYPE"))).selectByValue("1000110");;
		Thread.sleep(1000);
		driver.findElement(By.id("save_button")).click();
		Thread.sleep(2000);

		String eventType= driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("span")).getText();
		AssertJUnit.assertEquals(eventType, "Project Event");
		
		log.info("--------------------------------------------");
	}
	
	@Test(description = "Supplier create estimate - step 6")
	public void testSupplierDeleteEvent() throws InterruptedException, AWTException {
		String estRefNo;
		//projectName =  "Selenium198183";
...
*/
	...
	public void testOutsourcerInvoiceAcceptance() throws Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("invoiceListPage.closeButton")).click();
		Thread.sleep(1000);
	...
	@Test(description = "Create invoice - step 14")
	public void testViewInvoice() throws InterruptedException {
		Thread.sleep(3000);

		List<WebElement> classNames = driver.findElements(By.className("MuiTableRow-root"));
	...
	//	Thread.sleep(5000);
		...
		Thread.sleep(2000);
		driver.findElement(By.className("MuiListItem-root")).findElement(By.tagName("a")).click();
		Thread.sleep(1000);
		driver.navigate().back();
		Thread.sleep(5000);
...
/*
	...
	List<WebElement> calendars = driver.findElements(By.className("MuiInputAdornment-root"));

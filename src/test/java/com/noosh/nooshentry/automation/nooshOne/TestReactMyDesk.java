...
public class TestReactMyDesk extends BaseSeleniumTest {
    ...
    public static void testSwitchWorkGroupsPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		inputs.get(3).click();
		inputs.get(3).sendKeys("apple");
		Thread.sleep(500);
		inputs.get(3).sendKeys(Keys.ESCAPE);	
		Thread.sleep(500);
    ...
    public static void testEventListPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		Thread.sleep(5500);
		driver.findElement(By.name("trtable")).findElement(By.tagName("a")).click();
		Thread.sleep(5000);
    ...
    public static void testTaskListPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		WebElement myDeskLink = driver.findElement(By.className("glb-ent-top-wrapper")).findElement(By.tagName("a"));
		Actions builder = new Actions(driver);
		Thread.sleep(1500);
		builder.moveToElement(myDeskLink).perform();
		Thread.sleep(1500);
		...
		inputs.get(1).click();
		Thread.sleep(500);
		inputs.get(1).findElement(By.tagName("input")).sendKeys("5150615");;
		Thread.sleep(500);
		...
		AssertJUnit.assertEquals(taskNum, "Other");

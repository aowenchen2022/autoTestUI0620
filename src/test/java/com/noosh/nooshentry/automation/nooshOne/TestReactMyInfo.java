...
public class TestReactMyInfo extends BaseSeleniumTest {
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testCheckMyInfoPage(String BuyberWorkGroupNmae) throws InterruptedException{
		Thread.sleep(3500);
		...
		buttons.get(1).click();
		Thread.sleep(2000);
		if (driver.findElement(By.className("required")).isDisplayed() == true)
		{
			driver.findElement(By.id("cancel")).click();
			Thread.sleep(2000);
		}
		List <WebElement> buttonsAgain = driver.findElements(By.className("MuiButton-label"));
		buttonsAgain.get(2).click();
		Thread.sleep(2000);
		driver.findElement(By.id("pagerEmail")).clear();
		Thread.sleep(500);
		driver.findElement(By.id("pagerEmail")).sendKeys("test@noosh.com");
		Thread.sleep(500);
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testInLineEditWorkgroup(String BuyberWorkGroupNmae) throws InterruptedException{
		

		//WebElement myInfoLink = driver.findElement(By.className("MuiAvatar-root"));
		/*WebElement myInfoLink = driver.findElement(By.className("glb-nmh-profile"));
		Actions builder = new Actions(driver);
		Thread.sleep(1500);
		builder.moveToElement(myInfoLink).perform();
	...
	*/	
    ...
    public static void testInLineEditWorkgroupAgain(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		builder.moveToElement(myInfoLink).moveToElement(driver.findElement(By.linkText("My Info"))).click().perform();
		Thread.sleep(4000);
		builder.moveToElement(driver.findElement(By.xpath("myInfoPage.defaultWorkgroupLink"))).perform();
		Thread.sleep(1000);
		clickPencilIcon(0);
		new Select(driver.findElement(By.tagName("select"))).selectByValue("5016866");
		Thread.sleep(1500);
		clickPencilIcon(0);
		}

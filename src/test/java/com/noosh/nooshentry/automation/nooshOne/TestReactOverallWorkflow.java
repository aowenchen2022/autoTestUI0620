...
public class TestReactOverallWorkflow extends BaseSeleniumTest {
	...
	@Test(description = "Outsourcer select Client - step 2.4 ")
	public static void testSelectContactReact(String username, WebElement e) throws Exception{
	...
	public void testInviteTeamMembers(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.className("fa-users")).click();
		Thread.sleep(4000);
		List<WebElement> buttons = driver.findElements(By.className("MuiButton-text"));
		
		buttons.get(1).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("invite.InviteSelectedContacts")).click();
		Thread.sleep(1000);
		WebElement clientInput = driver.findElement(By.xpath("invite.InviteSelectedContacts")).findElement(By.tagName("input"));
		testSelectContactReact("Dgs1g1 mgr1", clientInput);
		Thread.sleep(2000);
		List <WebElement> myButtons = driver.findElements(By.tagName("button"));
		myButtons.get(1).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("invite.inviteSendInvitationButton")).click();
		Thread.sleep(5000);
			}
	
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testInviteSupplier(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		//driver.findElement(By.className("fa-users")).click();
		Thread.sleep(4000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testInviteClients(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		//driver.findElement(By.className("fa-users")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(1000);
		WebElement clientInput = driver.findElement(By.xpath("invite.InviteSelectedContacts")).findElement(By.tagName("input"));
		testSelectContactReact("Dgb1g1", clientInput);
		Thread.sleep(2000);
		List <WebElement> myButtons = driver.findElements(By.tagName("button"));
		myButtons.get(1).click();
	...
	@Test(description = "Create Spec - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testCopySpecs(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;
		...
		Thread.sleep(5000);
	//	driver.findElement(By.linkText("Create...")).click();
		List<WebElement> svg = driver.findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiSvgIcon-root"));
		Thread.sleep(2000);
		Actions builder = new Actions(driver);
		builder.moveToElement(svg.get(1)).perform();
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		builder.moveToElement(confMenus.get(1).findElement(By.tagName("li"))).click().perform();
		Thread.sleep(3000);
	...
	//	WebElement supplier2Input = driver.findElement(By.className("contactSelectorContainer")).findElement(By.tagName("input"));
		//driver.findElement(By.className("MuiInputLabel-outlined")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("rfePage.sendRfeButton")).click();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		Thread.sleep(6000);
...
/*
		...
		Thread.sleep(1000);
		nobrs.get(2).findElement(By.tagName("input")).clear();
		Thread.sleep(1000);
	...
	public void testReviewEst() throws Exception {
		//HomePage homePage = new HomePage(driver);
	...
	@Test(description = "Outsourcer create quote - step 7")
	public void testAwardOrder() throws Exception {
	
		Thread.sleep(1000);
		driver.findElement(By.xpath("estmatePage.awardOrderButton")).click();
		Thread.sleep(2000);
	...
	public void testSellOrderCreate() throws InterruptedException {
		...
		driver.findElement(By.id("resultTable")).findElement(By.tagName("a")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("orderListPage.markupSummaryTab")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("orderListPage.markupDetailTab")).click();
		Thread.sleep(5000);
	//	String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
	//	AssertJUnit.assertEquals(totalMarkup, "$10.0000");
		Thread.sleep(1000); 
	...
	@Test(description = "switch workgroup ")
    public static void testEventListPage() throws InterruptedException{
		
		driver.findElement(By.className("MuiToolbar-regular")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);
	...
	@Test(description = "switch workgroup ")
	public static void testTaskListPage() throws InterruptedException{
		
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		WebElement myDeskLink = driver.findElement(By.className("zebra")).findElement(By.tagName("a"));
		Actions builder = new Actions(driver);
		Thread.sleep(1500);
		builder.moveToElement(myDeskLink).perform();
		Thread.sleep(1500);
		...
		inputs.get(0).click();
		Thread.sleep(500);
		inputs.get(0).findElement(By.tagName("input")).sendKeys("5567965");;
		Thread.sleep(500);
		List<WebElement> svg = driver.findElements(By.className("MuiSvgIcon-root"));
		...
		AssertJUnit.assertEquals(taskNum, "Order rfe1-orde Requires Approval");
	
	}
	
	@Test(description = "switch workgroup ")
    public static void testMessageListPage() throws InterruptedException{
		...
		builder.moveToElement(myDeskLink).perform();
		Thread.sleep(1500);
		builder.moveToElement(myDeskLink).moveToElement(driver.findElement(By.linkText("Messages"))).click().perform();
		Thread.sleep(5500);
		driver.findElement(By.className("MuiFormControlLabel-root")).findElement(By.tagName("input")).click();
		Thread.sleep(5000);
		}
	
	 @Test(description="SSO-1, Go to Noosh Entry through sites menu")
	 @Parameters() 
	 public void testWorkSpaceCheck() throws Exception {    
		log.info("Start: testMyDeskPage");
		ManagerPage managerPage = new ManagerPage(driver);
		managerPage.FilterCriteria("Projects");
		managerPage.checkWorkspaceManager("Projects");
		managerPage.FilterCriteria("RFEs");
		managerPage.checkWorkspaceManager("RFEs");
		managerPage.FilterCriteria("Estimates");
		managerPage.checkWorkspaceManager("Estimates");
		managerPage.FilterCriteria("RFQs");
		managerPage.checkWorkspaceManager("RFQs");
		managerPage.FilterCriteria("Quotes");
		managerPage.checkWorkspaceManager("Quotes");
		managerPage.FilterCriteria("Orders");
		managerPage.checkWorkspaceManager("Orders");
		managerPage.FilterCriteria("Invoices");
		managerPage.checkWorkspaceManager("Invoices");
		managerPage.FilterCriteria("Job ID");
		managerPage.checkWorkspaceManager("Job ID");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testAddNooshContacts(String specName, String Quantity)
				throws InterruptedException, AWTException {
			log.info("Start: testSPcreateSpecWizard");
			driver.findElement(By.xpath("addressBookPage.addNooshContactsButton")).click();
			Thread.sleep(1000);
	       
			List<WebElement> inputs = driver.findElements(By.className("MuiInputBase-fullWidth"));
			inputs.get(0).findElement(By.tagName("input")).click();
			Thread.sleep(500);
			inputs.get(0).findElement(By.tagName("input")).sendKeys("test");

			inputs.get(1).findElement(By.tagName("input")).click();
			Thread.sleep(500);
			inputs.get(1).findElement(By.tagName("input")).sendKeys("test");
			inputs.get(2).findElement(By.tagName("input")).click();
			Thread.sleep(500);
			inputs.get(2).findElement(By.tagName("input")).sendKeys("nobody@noosh.com");
			
			inputs.get(3).findElement(By.tagName("input")).click();
			Thread.sleep(500);
			inputs.get(3).findElement(By.tagName("input")).sendKeys("test co demo");
			Thread.sleep(1000);

			driver.findElement(By.className("MuiSvgIcon-root")).click();
			Thread.sleep(2000);

			List<WebElement> names = driver.findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));
			String projectNum = names.get(2).getText();
			Assert.assertEquals(projectNum, "test, test");
		
			//driver.findElement(By.className("MuiIconButton-label")).findElement(By.tagName("input")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("addressBookPage.createContactsButton")).click();
			Thread.sleep(4000);
			log.info("End: testCreateSpec");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testDeleteNooshContacts(String specName, String Quantity)
					throws InterruptedException, AWTException {
			
			log.info("Start: testSPcreateSpecWizard");
			driver.findElement(By.className("MuiOutlinedInput-root")).click();

			Thread.sleep(1000);
			driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).clear();

			driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys("test co demo");
			Thread.sleep(1000);
	 		List<WebElement> dropDown = driver.findElements(By.className("MuiSelect-select"));
	        JavascriptExecutor executor = (JavascriptExecutor) driver;
	        executor.executeScript("arguments[0].click();", dropDown.get(1));
			Thread.sleep(1000);
			List<WebElement> options = driver.findElements(By.className("MuiListItem-button"));
			options.get(0).click();
			Thread.sleep(1000);
			List<WebElement> svg = driver.findElements(By.className("MuiSvgIcon-root"));
			svg.get(1).click();
			...
			Thread.sleep(1000);
			List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
			List<WebElement> optionss = confMenus.get(1).findElements(By.tagName("li"));
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testShippingAddresses(String specName, String Quantity)
				throws InterruptedException, AWTException {
			log.info("Start: testSPcreateSpecWizard");
			for (String handle : driver.getWindowHandles()) {
				driver.switchTo().window(handle);
			}
			driver.findElement(By.xpath("addressBookPage.addNonNooshContactsButton")).click();
			Thread.sleep(4000);
			driver.findElement(By.id("firstName")).sendKeys("testNonNooshFN");
			Thread.sleep(1000);
			driver.findElement(By.id("lastName")).sendKeys("testNonNooshLN");
			Thread.sleep(1000);
			driver.findElement(By.id("isSharedContact")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("addressBookPage.saveButton")).click();
			Thread.sleep(5000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testManageCategories(String specName, String Quantity)
					throws InterruptedException, AWTException {
			...
			driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys("testNo");
			Thread.sleep(1000);
			List<WebElement> dropDown = driver.findElements(By.className("MuiSelect-select"));
	        JavascriptExecutor executor = (JavascriptExecutor) driver;
	        executor.executeScript("arguments[0].click();", dropDown.get(1));
			...
			Thread.sleep(1000);
			List<WebElement> li = confMenus.get(1).findElements(By.tagName("li"));
			builder.moveToElement(li.get(2)).click().perform();
			Thread.sleep(5000);
			driver.findElements(By.tagName("input")).get(4).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("addressBookPage.addAddToCategoriesButton")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("addressBookPage.returnToContactsListButton")).click();
			Thread.sleep(3000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testDeleteNonNooshContacts(String specName, String Quantity)
					throws InterruptedException, AWTException {
			...
			driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys("testNon");
			Thread.sleep(1000);
	 		List<WebElement> dropDown = driver.findElements(By.className("MuiSelect-select"));
	        JavascriptExecutor executor = (JavascriptExecutor) driver;
	        executor.executeScript("arguments[0].click();", dropDown.get(1));
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testViewCategoriesPage(String specName, String Quantity)
				throws InterruptedException, AWTException {
			log.info("Start: testSPcreateSpecWizard");

			List<WebElement> Links = driver.findElements(By.className("MuiTab-textColorInherit"));
			Links.get(1).click();
			Thread.sleep(4000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testAddCategory(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.xpath("categoriesPage.addCategoryButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.name("name")).sendKeys("1test");
		Thread.sleep(1000);
		driver.findElement(By.id("categoryIsShared")).click();
		driver.findElement(By.xpath("categoriesPage.contactsLink")).click();
		Thread.sleep(4000);
		driver.findElement(By.className("MuiOutlinedInput-root")).click();
		Thread.sleep(1000);

		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys("DHs1g1 mgr1");;
		Thread.sleep(1000);
		driver.findElement(By.xpath("categoriesPage.searchButton")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("categoriesPage.selectallCheckbox")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("categoriesPage.addSelectedButton")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("categoriesPage.addButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("categoriesPage.createAndAddAnotherButton")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("categoriesPage.cancelButton")).click();
		Thread.sleep(4000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testDeleteCategory(String specName, String Quantity)
				throws InterruptedException, AWTException {
	...
	public void testAction() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("orderListPage.goButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("orderListPage.backButton")).click();		
		Thread.sleep(1000);
		log.info("--------------------------------------------");
	}
	...
	@Test(description = "Create order - step 8")
	public void testDefaultOrderSummary () throws Exception {
		...
		builder.moveToElement(orderLnks.get(0)).perform();
		Thread.sleep(2000);
		builder.moveToElement(orderLnks.get(0)).moveToElement(driver.findElement(By.linkText("Markup Summary"))).click().perform();
		Thread.sleep(2000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "$0.0000");
		Thread.sleep(1000); 
	...
	//	JavascriptExecutor executor = (JavascriptExecutor) driver;
    //    executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("orderListPage.markupDetailCheckbox")));
		driver.findElement(By.xpath("orderListPage.markupDetailCheckbox")).click();
		Thread.sleep(1000);

		driver.findElement(By.xpath("orderListPage.markupDetailButton")).click();
		Thread.sleep(1000); 
		/*
		builder.moveToElement(markupSummaryTab).click().perform();
		Thread.sleep(1000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "-$1,000.0000");
		Thread.sleep(1000); 
		*/
		log.info("--------------------------------------------");
	}
	...
	@Test(description = "Create order - step 8")
	public void testCreateBuyOrderAgain() throws Exception {
		...
		builder.moveToElement(orderLnks.get(1)).moveToElement(driver.findElement(By.className("glb-flyout")).findElement(By.linkText("Create..."))).click().perform();
		Thread.sleep(5500);
		driver.findElement(By.id("specRefId")).click();
		Thread.sleep(1000); 
		driver.findElement(By.id("create_quick_order")).click();
		//CommonUtils commonUtils = new CommonUtils(driver);
		//commonUtils.testChooseCalendar();
		Thread.sleep(2000); 
		...
		driver.findElement(By.id("orderItem1.unitPrice")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("orderItem1.unitPrice")).sendKeys("2");
		...
		driver.findElement(By.id("confirm_order_creation")).click();
		Thread.sleep(8000);
/*		WebElement markupSummaryTab = driver.findElement(By.xpath("orderListPage.markupDetailTab"));
		Thread.sleep(1500);
		driver.findElement(By.xpath("orderListPage.markupDetailCheckbox")).click();
		Thread.sleep(1000);
	...
	@Test(description = "Create order - step 8")
	public void testCreateArchiveSpec () throws Exception {
		...
		Actions builder = new Actions(driver);
		builder.moveToElement(svg.get(3)).perform();
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		//List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		builder.moveToElement(driver.findElement(By.xpath("specListPage.archiveSpecButton"))).click().perform();
		Thread.sleep(2000);
		driver.findElement(By.linkText("Orders")).click();
		Thread.sleep(2000);
		driver.navigate().refresh();
		Thread.sleep(2000);
		builder.moveToElement(driver.findElement(By.xpath("orderListPage.markupDetailTab"))).click().perform();
		Thread.sleep(1000);
	//	driver.findElement(By.xpath("orderListPage.markupDetailTab")).click();
		Thread.sleep(2000);
		for (String handle : driver.getWindowHandles()) {
		...
		JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("orderListPage.markupDetailCheckbox2")));
...
*/
	...
	public void testChangeOrderCreate() throws Exception {
		...
		Thread.sleep(1000);
		List<WebElement> inputs = driver.findElements(By.tagName("nobr"));
		inputs.get(1).findElement(By.tagName("input")).click();
		inputs.get(1).findElement(By.tagName("input")).clear();
		Thread.sleep(1000);

		inputs.get(1).findElement(By.tagName("input")).sendKeys("100");
		Thread.sleep(1000);
		
		inputs.get(1).findElement(By.tagName("input")).sendKeys(Keys.TAB);
		Thread.sleep(1000);
		...
		WebElement markupSummaryTab = driver.findElement(By.xpath("orderListPage.markupSummaryTab"));
		Thread.sleep(1500);
		Actions builder = new Actions(driver);
		builder.moveToElement(markupSummaryTab).click().perform();
		Thread.sleep(3000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "-$100.0000");
		Thread.sleep(1000); 
	...
	@Test(description = "Create change order - step 114")
	public void testSellChangeOrderCreate() throws Exception {
		...
		Thread.sleep(3000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
		AssertJUnit.assertEquals(totalMarkup, "$110.0000");
		Thread.sleep(1000); 
	...
	@Parameters({ "BuyberWorkGroupNmae"})
	public void testSupplierChangeOrderAcceptance(String BuyberWorkGroupNmae) throws Exception {
		driver.findElement(By.className("glb-wdgt-tasks-project-tasks")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);
	...
	public void testCreateQuote(String specName, String Quantity)
		...
		Thread.sleep(1500);
		builder.moveToElement(driver.findElement(By.xpath("quotePage.createQuoteButton"))).click().perform();
		Thread.sleep(1000);
	...
	public void testViewFinalInvoice() throws InterruptedException {
		...
		Thread.sleep(3000);
		List <WebElement>invoiceLinks = driver.findElement(By.id("resultTableWrap	per")).findElements(By.tagName("a"));
...
/*
	...
	public void testCreateMSG() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("messagePage.contactsButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiIconButton-label")).findElement(By.tagName("input")).click();
		Thread.sleep(500);
		...
		List <WebElement> inputs = driver.findElements(By.className("MuiOutlinedInput-marginDense"));
		inputs.get(0).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		inputs.get(0).findElement(By.tagName("input")).sendKeys("Subject1");
		Thread.sleep(1000);
		inputs.get(2).click();
		Thread.sleep(1000);
		inputs.get(2).findElement(By.tagName("textarea")).sendKeys("content1");
		Thread.sleep(1000);
	...
	public void testSupplierReplyMSG() throws Exception {
		...
		WebElement cogMenu = driver.findElement(By.xpath("messagePage.cogMenuButton"));
		Thread.sleep(1000);
		Actions builder = new Actions(driver);
		builder.moveToElement(cogMenu).perform();
		Thread.sleep(1000);
		List<WebElement> options = driver.findElements(By.className("MuiTouchRipple-root"));
		builder.moveToElement(options.get(4)).click().perform();
		Thread.sleep(1000);
		List <WebElement> inputs = driver.findElements(By.className("MuiOutlinedInput-marginDense"));
		inputs.get(2).click();
		Thread.sleep(1000);
		inputs.get(2).findElement(By.tagName("textarea")).sendKeys("Content2");
		Thread.sleep(1000);
		driver.findElement(By.xpath("messagePage.replyMessageButton")).click();
		Thread.sleep(4000);
		log.info("--------------------------------------------");
	}

	@Test(description = "Reply Message - step 11-2")
	public void testViewReplyMSG() throws Exception {
		Thread.sleep(4000);
		driver.findElement(By.className("glb-wdgt-msg-line-content")).findElement(By.tagName("a")).click();
	...
	public void testCreateTask() throws Exception {
		...
		buttons.get(1).click();
		Thread.sleep(5000);
		new Select(driver.findElement(By.id("taskTypeId"))).selectByValue("1000006");
		
		WebElement assignName = driver.findElement(By.className("contactSelectorContainer")).findElement(By.tagName("input"));
    ...
    public static void chooseCalendar(int index) throws InterruptedException{
    	Thread.sleep(2000); 
    	driver.findElement(By.xpath("rfePage.calendarButton")).click();
    	Thread.sleep(1000); 
    	driver.findElement(By.xpath("commonPage.calendarNextButton")).click();
    	Thread.sleep(1000);

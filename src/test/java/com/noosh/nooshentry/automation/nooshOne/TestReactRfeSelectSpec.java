...
public class TestReactRfeSelectSpec extends BaseSeleniumTest {
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiInputBase-formControl")).findElement(By.tagName("input")).sendKeys("Spec01");
		Thread.sleep(1000);

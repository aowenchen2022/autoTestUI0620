...
public class TestReactTeamListInvite extends BaseSeleniumTest {
...
*/
    ...
    public static void selectWorkGroups(String workgroups) throws InterruptedException{
    	...
    	Thread.sleep(1500);
    	builder.moveToElement(adminLnk).moveToElement(driver.findElement(By.className("workgroups-dropdown")).findElement(By.tagName("li"))).click()
    	.build().perform();

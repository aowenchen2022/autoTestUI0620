...
public class TestReskinAddShippingAddress extends BaseSeleniumTest {
	...
	public void testViewAddressBookPage(String specName, String Quantity)
		...
		Links.get(0).click();
		Thread.sleep(5000);
		List<WebElement> inputs = driver.findElements(By.className("MuiFormControl-root"));
		String email = inputs.get(8).findElement(By.tagName("input")).getAttribute("value");
		Assert.assertEquals(email, "nobody@noosh.com");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testViewShippingAddress(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		List<WebElement> Links = driver.findElements(By.className("MuiTableBody-root"));
		Links.get(0).findElement(By.tagName("a")).click();
		Thread.sleep(5000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSupplierViewShippingAddress(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testMemeberViewShippingAddress(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		List<WebElement> Links = driver.findElements(By.className("MuiTableBody-root"));
		Links.get(0).findElement(By.tagName("a")).click();
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testPrintIcon(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		
		Thread.sleep(2000);
		driver.findElement(By.xpath("addressBookPageReskin.caretIcon")).click();
		Thread.sleep(1000);
		...
		executor.executeScript("return document.querySelector"
				+ "('print-preview-app').shadowRoot.querySelector('print-preview-sidebar').shadowRoot"
		...
		((JavascriptExecutor)driver).executeAsyncScript(
		    ...
		    "arguments[0].click();"
		    , driver.findElement(By.className("cancel-button")));
		Thread.sleep(6000);
...
*/
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindBox(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");

        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiFormControl-marginDense")));
		
		Thread.sleep(1000);

		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("testFN");
		Thread.sleep(1000);
		driver.findElement(By.xpath("selectSpecPage.searchButton")).click();
		Thread.sleep(5000);
		
		List<WebElement> projectNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String projectNum = projectNums.get(0).getText();
		Assert.assertEquals(projectNum, "testLN, testFN");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSupplierSearchFindBox(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		...
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("SupplierTestFN");
		Thread.sleep(1000);
		driver.findElement(By.xpath("selectSpecPage.searchButton")).click();
		Thread.sleep(5000);
		...
		List<WebElement> projectNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String projectNum = projectNums.get(0).getText();
		Assert.assertEquals(projectNum, "SupplierTestLN, SupplierTestFN");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testMemberSearchFindBox(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		Thread.sleep(2000);
		List<WebElement> Links = driver.findElements(By.className("glb-main-button"));
		Links.get(2).click();
		Thread.sleep(5000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testShowContactsFrom(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
...
//		driver.findElement(By.className("MuiIconButton-label")).findElement(By.tagName("input")).click();
		...
		List<WebElement> projectNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String projectNum = projectNums.get(0).getText();
		Assert.assertEquals(projectNum, "mgr1, Dgs1g1");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testAddShippingAddress(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		Thread.sleep(2000);
		List<WebElement> Links = driver.findElements(By.className("glb-main-button"));
		...
		inputs.get(0).click();
		Thread.sleep(500);
		inputs.get(0).findElement(By.tagName("input")).sendKeys("testFN");

		inputs.get(1).click();
		Thread.sleep(500);
		inputs.get(1).findElement(By.tagName("input")).sendKeys("testMN");
		
		inputs.get(2).click();
		Thread.sleep(500);
		inputs.get(2).findElement(By.tagName("input")).sendKeys("testLN");
		
		inputs.get(8).click();
		Thread.sleep(500);
		inputs.get(8).findElement(By.tagName("input")).sendKeys("nobody@noosh.com");
		Thread.sleep(1000);

		driver.findElement(By.className("MuiCheckbox-colorPrimary")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("addressBookPageReskin.saveButton")).click();
		Thread.sleep(4000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSupplierAddShippingAddress(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		List<WebElement> Links = driver.findElements(By.className("glb-main-button"));
		Links.get(2).click();
		...
		List<WebElement> inputs = driver.findElements(By.className("MuiFormControl-marginDense"));
		inputs.get(0).click();
		Thread.sleep(500);
		inputs.get(0).findElement(By.tagName("input")).sendKeys("SupplierTestFN");

		inputs.get(1).click();
		Thread.sleep(500);
		inputs.get(1).findElement(By.tagName("input")).sendKeys("SupplierTestMN");
		
		inputs.get(2).click();
		Thread.sleep(500);
		inputs.get(2).findElement(By.tagName("input")).sendKeys("SupplierTestLN");
	...
	public void testAddCategory(String specName, String Quantity)
		...
		Thread.sleep(3000);
		driver.findElement(By.className("MuiInputBase-formControl")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiInputBase-formControl")).findElement(By.tagName("input")).sendKeys("1test");
		Thread.sleep(1000);
		driver.findElement(By.xpath("commonPage.potentialAlertYesButtons")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("rfePage.addContactButton")).click();
		Thread.sleep(4000);
		
		List<WebElement> divs = driver.findElements(By.className("MuiOutlinedInput-marginDense"));
		divs.get(2).click();
		Thread.sleep(1000);

		divs.get(2).findElement(By.tagName("input")).sendKeys("DHs1g1 mgr1");;
		Thread.sleep(1000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testEditcategory(String specName, String Quantity)
				throws InterruptedException, AWTException {
		...
		builder.moveToElement(confMenus.get(2).findElement(By.tagName("li"))).click().perform();
		builder.release();
		Thread.sleep(3000);
		driver.findElement(By.xpath("categoriesPage.editSelectallCheckbox")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("categoriesPage.removeButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("categoriesPage.viewCategoryListButton")).click();
		Thread.sleep(4000);
	...
	public void testDeleteCategory(String specName, String Quantity)
		...
		Thread.sleep(1000);
		List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		List<WebElement> optionss = confMenus.get(2).findElements(By.tagName("li"));
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testEditNooshContacts(String specName, String Quantity)
				throws InterruptedException, AWTException {
		
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.className("MuiTextField-root")).click();
		Thread.sleep(1000);

		driver.findElement(By.className("MuiTextField-root")).findElement(By.tagName("input")).sendKeys("Biedermann GmbH");
		Thread.sleep(1000);
		List<WebElement> dropDown = driver.findElements(By.className("MuiSelect-select"));
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", dropDown.get(1));
...
//		svg.get(1).click();
		...
		List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		builder.moveToElement(confMenus.get(2)).perform();
		Thread.sleep(1000);
		List<WebElement> li = confMenus.get(2).findElements(By.tagName("li"));
		builder.moveToElement(li.get(0)).click().perform();
		Thread.sleep(5000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testEditNonNooshContacts(String specName, String Quantity)
				throws InterruptedException, AWTException {
		
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.className("MuiTextField-root")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiTextField-root")).findElement(By.tagName("input")).sendKeys("testNon");
		Thread.sleep(1000);
 		List<WebElement> dropDown = driver.findElements(By.className("MuiSelect-select"));
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", dropDown.get(1));
		...
		confMenus.get(2).findElement(By.tagName("li")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("addressBookPageReskin.saveButton")).click();
		Thread.sleep(5000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testDeleteShippingAddress(String specName, String Quantity)
				throws InterruptedException, AWTException {
		
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.xpath("addressBookPageReskin.deleteButton")).click();
		Thread.sleep(1000);
//		CommonUtils commonUtils = new CommonUtils(driver);
//		commonUtils.dealPotentialAlert(true);
		Thread.sleep(4000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSupplierDeleteShippingAddress(String specName, String Quantity)
				throws InterruptedException, AWTException {
...
//		commonUtils.dealPotentialAlert(true);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testAddNonNooshContacts(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		...
		driver.findElement(By.xpath("addressBookPage.addNonNooshContactsButton")).click();
		Thread.sleep(4000);
		List<WebElement> divs = driver.findElements(By.className("MuiInputBase-fullWidth"));
		divs.get(0).click();
		Thread.sleep(1000);
		divs.get(0).findElement(By.tagName("input")).sendKeys("testNonNooshFN");
		Thread.sleep(1000);
		divs.get(2).click();
		Thread.sleep(1000);
		divs.get(2).findElement(By.tagName("input")).sendKeys("testNonNooshLN");
		Thread.sleep(1000);

		driver.findElement(By.className("MuiIconButton-colorSecondary")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("addressBookPageReskin.saveButton")).click();
		Thread.sleep(5000);
	...
	@Test(description = "Member login")
	@Parameters({ "MemberLoginN", "AdminPassword" })
	public void testMemberLogin (String MemberLoginN, String AdminPassword) throws InterruptedException {
		testOutsourcerLogin(MemberLoginN, AdminPassword);
	}
	...
	public void testCreateInvoice(String specName, String Quantity)
		...
		.moveToElement(driver.findElement(By.xpath("newHomePage.createButton"))).click().perform();
		Thread.sleep(1000);

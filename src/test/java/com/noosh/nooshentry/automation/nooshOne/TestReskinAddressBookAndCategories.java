...
public class TestReskinAddressBookAndCategories extends BaseSeleniumTest {
	...
	public void testViewCategoriesPage(String specName, String Quantity)
		...
		List<WebElement> Links = driver.findElements(By.className("MuiTab-textColorPrimary"));
		Links.get(1).click();
		Thread.sleep(5000);
...
*/
	...
	public void testSearchFindBox(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("Dgs1g1 mgr1");
		Thread.sleep(1000);
	...
	public void testShowContactsFrom(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		List<WebElement> dropDown = driver.findElements(By.className("MuiFormControl-marginDense"));
  //      JavascriptExecutor executor = (JavascriptExecutor) driver;
  //      executor.executeScript("arguments[0].click();", dropDown.get(2));
		dropDown.get(2).click();
		Thread.sleep(1000);
		List<WebElement> options = driver.findElements(By.className("MuiMenuItem-root"));
		options.get(0).click();
		Thread.sleep(1000);
//		driver.findElement(By.className("MuiIconButton-label")).findElement(By.tagName("input")).click();
	...
	public void testAddCategory(String specName, String Quantity)
		...
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("1test");
		Thread.sleep(1000);
	...
	public void testEditNooshContacts(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("Biedermann GmbH");
		Thread.sleep(1000);
		List<WebElement> dropDown = driver.findElements(By.className("MuiFormControl-marginDense"));
 //       JavascriptExecutor executor = (JavascriptExecutor) driver;
  //      executor.executeScript("arguments[0].click();", dropDown.get(2));
...
//		svg.get(1).click();
		...
		Thread.sleep(1000);
		List<WebElement> li = confMenus.get(4).findElements(By.tagName("li"));
	...
	public void testEditNonNooshContacts(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiFormControl-marginDense")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("testNon");
		Thread.sleep(1000);
 		List<WebElement> dropDown = driver.findElements(By.className("MuiFormControl-marginDense"));
    //    JavascriptExecutor executor = (JavascriptExecutor) driver;
    //    executor.executeScript("arguments[0].click();", dropDown.get(2));
		...
		confMenus.get(4).findElement(By.tagName("li")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("addressBookPageReskin.saveButton")).click();
		Thread.sleep(5000);
  ...
  //      executor.executeScript("arguments[0].click();", dropDown.get(2));
		...
		Thread.sleep(1000);
		List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		List<WebElement> optionss = confMenus.get(4).findElements(By.tagName("li"));
	...
	public void testAddNonNooshContacts(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiCheckbox-colorPrimary")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("addressBookPageReskin.saveButton")).click();
		Thread.sleep(5000);

...
public class TestReskinBaseline extends BaseSeleniumTest {
	...
	@Parameters({ "fileForBaseline11" })
    public  void testCheckBaselinePage(String fileForBaseline11) throws InterruptedException, AWTException{
		Thread.sleep(1500);
		...
		Thread.sleep(1500);
		builder.moveToElement(myInfoLink).moveToElement(driver.findElement(By.linkText("My Group"))).click().perform();
		Thread.sleep(6000);
		driver.findElement(By.linkText("Baseline")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("isBaselineRequired")).click();
		Thread.sleep(1000);

		driver.findElement(By.xpath("baselinePage.brochureLinkReskin")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("baselinePage.pageCountCheckboxReskin")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("addressBookPage.saveButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.stayOnCurrentPageButtonReskin")).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("baselinePage.downloadTemplateButtonReskin")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("baselinePage.uploadComparsionFileButtonReskin")).click();
		Thread.sleep(3000);

	  	page.uploadFileModalWindow(fileForBaseline11);   
	    Thread.sleep(4000);
	  	page.robotPaste();
	  	Thread.sleep(2000);	
		...
		robot.keyRelease(KeyEvent.VK_ENTER);
	  	Thread.sleep(3000);	
	  	driver.findElement(By.className("MuiAlert-action")).findElement(By.tagName("button")).click();
	  	Thread.sleep(1000);	
		...
		List <WebElement> divs = driver.findElements(By.className("linkbox"));
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testCreateBaselineSpecs(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;

		Thread.sleep(1000);
		driver.findElement(By.xpath("leftToolBar.specsLink")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("specPage.createSpecButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("baselinePage.brochureSpecButtonReskin")).click();
		Thread.sleep(1000);
		List <WebElement> buttons = driver.findElements(By.className("MuiButton-containedPrimary"));
		buttons.get(1).click();
		Thread.sleep(3000);
		driver.switchTo().frame("mppv");

		driver.findElement(By.className("pe-dd-cellCard-valueEdit")).click();
		Thread.sleep(1000);

		driver.findElement(By.className("pe-dd-cellCard-valueEdit")).sendKeys("baselineSpec");
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.baselineSpecQuantityReskin")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.baselineSpecQuantityReskin")).sendKeys("1000");
		Thread.sleep(1000);

		new Select(driver.findElement(By.xpath("baselinePage.weightDropDownReskin"))).selectByVisibleText("80");;
		Thread.sleep(1000);
		new Select(driver.findElement(By.xpath("baselinePage.finishDropDownReskin"))).selectByVisibleText("Gloss");
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.stockNameDropDownReskin")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.stockNameDropDownReskin")).sendKeys("test stocks");
		Thread.sleep(1000);
		new Select(driver.findElement(By.xpath("baselinePage.stockTypeDropDownReskin"))).selectByVisibleText("Book");
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.pageCountDropDownReskin")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("baselinePage.pageCountDropDownReskin")).sendKeys("600");
		Thread.sleep(1000);
		List <WebElement> comments = driver.findElements(By.tagName("textarea"));
		comments.get(2).click();
		Thread.sleep(1000);
		comments.get(2).sendKeys("Stocks Comments");
		Thread.sleep(1000);
	...
	public void testTearDown(String specName)
			throws InterruptedException, AWTException {
		...
		driver.findElement(By.linkText("Baseline")).click();
		Thread.sleep(3000);
		List <WebElement> redios = 	driver.findElements(By.id("isBaselineRequired"));
		redios.get(1).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("myDeskPage.myDeskLink")).click();
		Thread.sleep(3000);
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		Actions builder = new Actions(driver);
		builder.moveToElement(driver.findElement(By.xpath("newHomePage.estimateLinkReskin"))).perform();
		Thread.sleep(1000);
		builder.moveToElement(driver.findElement(By.xpath("newHomePage.estimateLinkReskin"))).click().perform();
		Thread.sleep(1000);

		driver.findElement(By.xpath("newHomePage.estimateLinkReskin")).click();
		Thread.sleep(1000);
		List<WebElement> buttons = driver.findElements(By.className("MuiButton-containedPrimary"));
		buttons.get(1).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("rfePage.sealedBiddingCheckBox")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("rfePage.supplier1Checkbox")).click();
		Thread.sleep(1000);
	...
	public void testBuyOrderCreate() throws InterruptedException {
		...
		driver.findElement(By.name("proceed_to_confirmation")).click();
		Thread.sleep(3000);
		String errorMessage = driver.findElement(By.id("userErrorComponentTable")).findElement(By.tagName("strong")).getText();
	...
	public void testSupplierEstCreate() throws InterruptedException, AWTException {
		...
		driver.findElement(By.xpath("estimatePage.acceptRfeItemsButton")).click();
		Thread.sleep(2000);

		driver.findElement(By.tagName("nobr")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
	...
	public void testCheckEst() throws Exception {
		...
		Thread.sleep(4000);
	//	driver.findElement(By.xpath("estimatePage.viewEstimatesDetailsLink")).click();
		Thread.sleep(2000);

		List<WebElement> divs = driver.findElements(By.className("MuiSelect-select"));
		String baselineCategoryOption = divs.get(2).getText();
		System.out.println(baselineCategoryOption);

		divs.get(2).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("estmatePage.exactMatchOption")).click();;
		Thread.sleep(2000);
		driver.findElement(By.className("MuiDialog-paper")).findElement(By.tagName("input")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("baselinePage.confirmButtonReskin")).click();
		Thread.sleep(3000);

		divs.get(2).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("estmatePage.averageEstimatesOption")).click();
		Thread.sleep(3000);

		List<WebElement> tds = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("td"));
		String baseline = tds.get(2).getText();
		Thread.sleep(1000);
		AssertJUnit.assertEquals(baseline, "$1,000.000");
		
		driver.findElement(By.className("fa-chart-bar")).click();
		Thread.sleep(3000);
		Actions builder = new Actions(driver);
		builder.moveToElement(driver.findElement(By.id("main"))).perform();
		Thread.sleep(2000);

		String targetSavings = driver.findElement(By.xpath("baselinePage.targetSavingsReskin")).getText();
		System.out.print("targetSavings" + targetSavings);
		driver.navigate().refresh();
		Thread.sleep(5000);
...
/*
    ...
    public static void chooseCalendar(int index) throws InterruptedException{
    	Thread.sleep(1000); 
    	List<WebElement> calendars = driver.findElements(By.className("MuiIconButton-edgeEnd"));
    	calendars.get(index).click();
    	Thread.sleep(1000); 

...
public class TestReskinBuySellChangeOrderDetail extends BaseSeleniumTest {
	...
	public void testCreateBuyOrder() throws Exception {
		...
		Actions builder = new Actions(driver);
		builder.moveToElement(orderLnks.get(1)).click().perform();
		Thread.sleep(2000);
		...
		new Select(driver.findElement(By.id("@orderItem1.benchmarkType_str"))).selectByValue("5");
		Thread.sleep(1000); 
		WebElement supplierInput = driver.findElement(By.className("contactSelectorContainer")).findElement(By.tagName("input"));
...
/*		WebElement markupSummaryTab = driver.findElement(By.xpath("orderListPage.markupDetailTab"));
	...
	public void testSupplierOrderAcceptance() throws Exception {
		...
		.build().perform();
		Thread.sleep(5000);
		driver.findElement(By.xpath("orderPage.acceptButton")).click();
		CommonUtils commonUtils = new CommonUtils(driver);
		commonUtils.dealPotentialAlert(true);
		Thread.sleep(5000);
...
*/
	...
	public void testChangeOrderCreate() throws Exception {
		...
		Thread.sleep(8000);
		driver.findElement(By.xpath("buyOrderDetailPage.changeOrderLink")).click();
		Thread.sleep(2000);
	...
	public void testSellChangeOrderCreate() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("sellOrderDetailPage.sellChangeOrderLink")).click();
		Thread.sleep(3000);
	...
	public void testCreateQuote(String specName, String Quantity)
		...
		Actions builder = new Actions(driver);		
		builder.moveToElement(driver.findElement(By.xpath("newHomePage.quoteLinkReskin"))).perform();
		Thread.sleep(1500);
		builder.moveToElement(driver.findElement(By.xpath("newHomePage.createQuoteButtonReskin"))).click().perform();
		Thread.sleep(1000);
		driver.findElement(By.xpath("newHomePage.selectSpec02")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("continue")).click();
		Thread.sleep(2000);

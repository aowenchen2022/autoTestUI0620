...
public class TestReskinContactPopup extends BaseSeleniumTest {
...
//		driver.findElement(By.xpath("rfePage.sealedBiddingCheckBox")).click();
		...
		driver.findElement(By.className("MuiDialog-paperFullWidth")).findElement(By.className("MuiInputBase-colorPrimary")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("rfePage.supplier2Checkbox")).click();
		Thread.sleep(1000);

...
public class TestReskinCreateRfe extends BaseSeleniumTest {
	...
	public void testCreateSpecs2(String specName, String Quantity)
		...
		log.info("Start: testSPcreateSpecWizard");
		specName = unicID;
		driver.findElement(By.xpath("specPage.createSpecLink")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("specPage.envelopeRadio")).click();
		Thread.sleep(1000);
		Thread.sleep(1000);
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testCreateRfeWithoutSpec(String specName, String Quantity)
			throws Exception, AWTException {
		log.info("Start: testSPcreateRFE");
		specName = unicID;
		rfeName = projectName;
		 //driver.findElement(By.className("glb-wdgt-activities-list")).findElement(By.tagName("a")).click();
		driver.findElement(By.xpath("leftToolBar.Estimate")).click();
		Thread.sleep(4000);
		...
		List<WebElement> checkboxes	 = driver.findElement(By.className("MuiDialog-paperScrollPaper")).findElements(By.className("MuiTableCell-paddingCheckbox"));
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		Thread.sleep(1000);
		builder.moveToElement(driver.findElement(By.linkText("Create RFE..."))).click().perform();
		Thread.sleep(4000);
				
		driver.findElement(By.xpath("rfePage.selectSpec02checkBox")).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.xpath("rfePage.contactsLink")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("rfePage.supplierCheckbox")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("rfePage.addContactButton")).click();
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
		...
		driver.findElement(By.xpath("rfePage.addItemButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("selectedAll")).click();
		Thread.sleep(1000);
		List <WebElement> buttons2 = driver.findElements(By.className("MuiButton-containedPrimary"));
	...
	@Test(description = "Create RFE - step 5")
	@Parameters({ "productName1", "projectNameField" })
	public void testRfeAddItem(String specName, String Quantity)
			throws Exception, AWTException {
		log.info("Start: testSPcreateRFE");
		specName = unicID;
		rfeName = projectName;
		...
		List <WebElement> buttons2 = driver.findElements(By.className("MuiButton-label"));
		buttons2.get(1).click();
		Thread.sleep(2000);
		List <WebElement> inputs = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("input"));

		driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("input")).sendKeys("1000");
		inputs.get(10).sendKeys("100");
		inputs.get(15).sendKeys("100");
		Thread.sleep(1000);
	
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		List<WebElement> divs1 = driver.findElements(By.tagName("button"));
		divs1.get(1).click();
		Thread.sleep(2000);
		//List<WebElement> nexBbuttons = driver.findElement(By.className("MuiPickersCalendarHeader-switchHeader")).findElements(By.tagName("button"));
		executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("calendarPage.nextButton")));
		Thread.sleep(2000);

		WebElement dateButton = driver.findElement(By.xpath("searchManagerPage.calendarNum1"));
		  executor.executeScript("arguments[0].click();", dateButton);
		Thread.sleep(2000);
		
		
		List<WebElement> divs2 = driver.findElements(By.tagName("button"));
		executor.executeScript("arguments[0].click();", divs2.get(2));
		Thread.sleep(2000);
		//List<WebElement> nexBbuttons2 = driver.findElement(By.className("MuiPickersCalendarHeader-switchHeader")).findElements(By.tagName("button"));
		executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("calendarPage.nextButton")));
		Thread.sleep(2000);

		WebElement dateButton2 = driver.findElement(By.xpath("searchManagerPage.calendarNum1"));
		  executor.executeScript("arguments[0].click();", dateButton2);
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		List <WebElement> buttons3 = driver.findElements(By.className("MuiButton-label"));
		buttons3.get(2).click();
		Thread.sleep(6000);
...
/*
    ...
    public void testChooseCalendarNextMonth(int calendar ) throws InterruptedException, AWTException {
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		List<WebElement> divs1 = driver.findElements(By.className("MuiInputAdornment-root"));
		executor.executeScript("arguments[0].click();", divs1.get(calendar));
		Thread.sleep(2000);
		
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		List<WebElement> divs2 = driver.findElement(By.className("MuiPickersCalendarHeader-switchHeader")).findElements(By.tagName("button"));
		executor.executeScript("arguments[0].click();", divs2.get(1));
		Thread.sleep(2000);

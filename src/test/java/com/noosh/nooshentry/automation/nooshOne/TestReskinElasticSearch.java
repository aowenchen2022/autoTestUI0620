...
public class TestReskinElasticSearch extends BaseSeleniumTest {
...
*/
	...
	public  void elasticSearch(String inputValue) throws Exception {
		...
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).clear();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(inputValue);
		Thread.sleep(1000);
    ...
    public static void checkSearchResult(String expectedResult, int searchBodyIndex, int searchElementIndex) throws Exception {
    	List <WebElement> results = driver.findElements(By.className("MuiTableBody-root"));
    	List <WebElement> tds= results.get(searchBodyIndex).findElements(By.tagName("td"));
    	String originalText = tds.get(searchElementIndex).getText();
	...
	public void testSearchforProject(String cloudqaProjName, String cloudqaPorjId, String cloudqaProjNumber)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
	//	driver.findElement(By.className("glb-search-outer")).findElement(By.className("fa-search")).click();
		Thread.sleep(2000);
		driver.findElement(By.className("fa-caret-down")).click();
		Thread.sleep(1000);
		WebElement checkbox = driver.findElement(By.className("ng-binding"));
		String status = checkbox.findElement(By.tagName("input")).getAttribute("aria-checked").toString();
		System.out.print("value:" + status);
		String flag = "false";
		boolean a = (status.equals(flag));
		System.out.print(a);
        ...
        if (a == true) {
            driver.findElement(By.className("ng-binding")).findElement(By.tagName("input")).click();
            Thread.sleep(1000);
        }
		Thread.sleep(2000);
    	driver.findElement(By.className("glb-search-outer")).findElement(By.className("fa-search")).click();
		...
		checkSearchResult(cloudqaProjName,0,2);
		Thread.sleep(1000);
	...
	public void testSearchforEstimate(String cloudqaEstName, String cloudqaEstId, String cloudqaEstNumber)
		...
		checkSearchResult(cloudqaEstName,0,2);
		Thread.sleep(1000);
	...
	public void testSearchforRfe(String cloudqaRfeName, String cloudqaRfeId, String cloudqaRfeNumber)
		...
		checkSearchResult(cloudqaRfeName,1,2);
		Thread.sleep(1000);
		

		elasticSearch(cloudqaRfeId);
		checkSearchResult(cloudqaRfeName,0,2);
		Thread.sleep(1000);
	...
	public void testSearchforOrder(String cloudqaOrderName, String cloudqaOrderId, String cloudqaOrderNumber)
		...
		checkSearchResult(cloudqaOrderName,0,3);
		Thread.sleep(2000);
	...
	public void testSearchforChangeOrder(String cloudqaChangeOrderName, String cloudqaChangeOrderId, String cloudqaChangeOrderNumber)
		...
		checkSearchResult(cloudqaChangeOrderName,0,3);
		Thread.sleep(1000);
	...
	public void testSearchforQuote (String cloudqaQuoteName, String cloudqaQuoteId)
		...
		checkSearchResult(cloudqaQuoteName,1,1);
		Thread.sleep(1000);
		

		elasticSearch(cloudqaQuoteId);
		checkSearchResult(cloudqaQuoteName,0,1);
		Thread.sleep(1000);
...
/*
		...
		Thread.sleep(2000);
		checkSearchResult(cloudqaRfqName,0,1);
		Thread.sleep(1000);
	*/	

		elasticSearch(cloudqaRfqId);
		Thread.sleep(2000);
		checkSearchResult(cloudqaRfqId,0,0);
		Thread.sleep(1000);
	...
	public void testSearchforInvoice (String cloudqaInvoiceName, String cloudqaInvoiceId)
		...
		Thread.sleep(5000);
		checkSearchResult(cloudqaInvoiceName,1,2);
		Thread.sleep(1000);
		

		elasticSearch(cloudqaInvoiceId);
		Thread.sleep(3000);
		checkSearchResult(cloudqaInvoiceName,0,2);
		Thread.sleep(1000);

...
public class TestReskinEstimateDetail extends BaseSeleniumTest {
	...
	public void testSupplierEstCreate() throws InterruptedException, AWTException {
		...
		List<WebElement> checkboxes = driver.findElements(By.className("MuiCheckbox-colorDefault"));
		...
		driver.findElement(By.className("MuiFormControl-marginNormal")).click();
		Thread.sleep(1000);

		driver.findElement(By.className("MuiFormControl-marginNormal")).findElement(By.tagName("textarea")).sendKeys("Testing reason");
		Thread.sleep(1000);
		...
		driver.findElement(By.name("span_item_-2")).findElement(By.tagName("nobr")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
		driver.findElement(By.name("span_item_-2")).findElement(By.tagName("nobr")).findElement(By.tagName("input")).sendKeys("1000");
		driver.findElement(By.name("span_item_-2")).findElement(By.tagName("nobr")).findElement(By.tagName("input")).sendKeys("{Tab}");
		Thread.sleep(1000);

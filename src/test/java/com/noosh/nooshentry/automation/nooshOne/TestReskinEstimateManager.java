...
public class TestReskinEstimateManager extends BaseSeleniumTest {
	...
	public void testSearchFindBox(String specName, String Quantity)
		...
		projectName = myProjectNums.get(0).getText();
		System.out.print(projectName);

        JavascriptExecutor executor = (JavascriptExecutor) driver;
   //     executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiFormControl-root")));
        driver.findElement(By.className("MuiFormControl-marginDense")).click();
		Thread.sleep(2000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(projectName);
		Thread.sleep(1000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchEstimateStatus(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
...
*/
	...
	public  void testOutsourcerFilterCriteria() throws Exception {
		...
		Thread.sleep(2000);
//		reskinProjManagerUrl = "https://nooshonedemo." + domain +".noosh.com/workspace/estimateManager";

...
public class TestReskinFileSearch extends BaseSeleniumTest {
	...
	static String reskinProjManagerUrl;
	String firstWindow;
	String secondWindow;
	static String parentWindowHandle;
	static String smallFeaturesUrl;
	static String projectName="5140737";
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindBoxFileName(String specName, String Quantity)
		...
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("Sierra.png");
		Thread.sleep(1000);
		...
		List<WebElement> fileNames = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String fileName = fileNames.get(0).getText();
		Assert.assertEquals(fileName, "Sierra.png");
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindBoxFileTag(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
	    ...
	    executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiFormControl-marginDense")));
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).clear();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("selenium");
		Thread.sleep(1000);
        ...
        executor.executeScript("arguments[0].click();", options.get(1));
        Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(5000);
		
		
		List<WebElement> fileTags = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("span"));
		String fileTag = fileTags.get(0).getText();
		Assert.assertEquals(fileTag, "selenium");
	...
	public void testSearchCreateDate(String specName, String Quantity)
		...
		executor.executeScript("arguments[0].click();", divs.get(4));
		Thread.sleep(2000);
		...
		Assert.assertEquals(projectNum, projectName);
	}
	
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFileUploaded(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFileUI(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
        JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	public void testInlineEdits(String specName, String Quantity)
		...
		Actions builder = new Actions(driver);
		builder.moveToElement(driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("div"))).perform();
		Thread.sleep(2000);
		builder.moveToElement(driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("div"))).perform();
		Thread.sleep(8000);
		driver.findElement(By.xpath("projectManagerPage.editProjNameLink")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		builder.moveToElement(svgs.get(3)).click().perform();
		Thread.sleep(1000);
		...
		builder.moveToElement(svgs3.get(4)).click().perform();
		...
		Thread.sleep(1000);
		driver.findElement(By.className("MuiTableBody-root")).findElement(By.className("MuiOutlinedInput-input")).sendKeys(projectName);
		Thread.sleep(1000);
...
*/
	...
	public  void testOutsourcerFilterCriteria() throws Exception {
		driver.findElement(By.className("glb-ent-menu")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);

		ManagerPage managerPage = new ManagerPage(driver);
		managerPage.FilterCriteria("Files");
		Thread.sleep(5000);
	}
	...
	@Test(description="upload file - step 11")
    @Parameters({"fileForProject11"})
    public void testAddTag (String fileForProject11) throws InterruptedException, AWTException {    
  	   log.info("Start: test testAddTag");
  	      
  	     
  	   Thread.sleep(3000);

  	   driver.switchTo().frame("mppv");
  	   driver.findElement(By.className("add-tag-btn")).click();
  	   Thread.sleep(1000);
  	   driver.findElement(By.className("token-input-list-facebook")).click();
  	   Thread.sleep(1000);
  	   driver.findElement(By.id("token-input-")).sendKeys("selenium");
  	   Thread.sleep(1000);

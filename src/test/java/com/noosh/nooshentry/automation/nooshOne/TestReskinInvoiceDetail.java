...
public class TestReskinInvoiceDetail extends BaseSeleniumTest {
	...
	@Test(description = "Outsourcer login5")
	@Parameters({ "OutsourcerLoginN", "AdminPassword" })
	public void testOutsourcerLogin5th (String OutsourcerLoginN, String AdminPassword) throws InterruptedException {
		testOutsourcerLogin(OutsourcerLoginN, AdminPassword);
	}
	...
	public void testCreateInvoice(String specName, String Quantity)
		...
		.moveToElement(driver.findElement(By.xpath("newHomePage.createButton2"))).click().perform();
		Thread.sleep(1000);
...
*/
	...
	public void testCloseChangeOrderCreate() throws Exception {
		...
		driver.findElement(By.className("MuiTable-root")).findElement(By.tagName("a")).click();
		Thread.sleep(2000);
	...
	public void testViewFinalInvoice() throws InterruptedException {
		...
		Thread.sleep(3000);
		List <WebElement>invoiceLinks = driver.findElements(By.className("MuiTableRow-root"));
		invoiceLinks.get(3).findElement(By.tagName("a")).click();
		Thread.sleep(5000);

...
public class TestReskinInvoiceList extends BaseSeleniumTest {
...
*/
	...
	public void testSellInvoiceCreate() throws InterruptedException {
		...
		builder.moveToElement(driver.findElement(By.className("fa-file-alt"))).perform();
		Thread.sleep(1000);
		builder.moveToElement(driver.findElement(By.xpath("newHomePage.createButton2"))).click().perform();
		Thread.sleep(2000);
		driver.findElement(By.id("orderId")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("create")).click();
	...
	//	List<WebElement> confMenus = driver.findElements(By.className("MuiTableRow-root"));
	//	Actions builder = new Actions(driver);

...
public class TestReskinJobIdManager extends BaseSeleniumTest {
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindJobId(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		jobId = "5176074";
		JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("div")));
        Thread.sleep(1000);
        driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(jobId);
		
		

        if (driver.findElement(By.className("MuiFormControlLabel-labelPlacementEnd")).findElement(By.className("Mui-checked")).isDisplayed()== true) {
            driver.findElement(By.className("MuiFormControlLabel-labelPlacementEnd")).findElement(By.tagName("input")).click();
            Thread.sleep(1000);
        }
		...
		Assert.assertEquals(projectNum, "bl1");
		...
		List<WebElement> projectNums2 = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("td"));
		String projectNum2 = projectNums2.get(4).getText();
		Assert.assertEquals(projectNum2, "5067007");

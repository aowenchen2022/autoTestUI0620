...
public class TestReskinManageCategory extends BaseSeleniumTest {
	...
	public void testViewCategoriesPage(String specName, String Quantity)
		...
		List<WebElement> categoryLinks = driver.findElements(By.className("MuiTab-textColorPrimary"));
...
*/
	...
	public void testSearchFindBox(String specName, String Quantity)
        ...
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiTextField-root")));
		
		Thread.sleep(1000);

		driver.findElement(By.className("MuiTextField-root")).findElement(By.tagName("input")).sendKeys("Dgs1g1 mgr1");
		Thread.sleep(1000);
...
//		driver.findElement(By.className("MuiIconButton-label")).findElement(By.tagName("input")).click();
	...
	public void testAddNooshContacts(String specName, String Quantity)
		...
		inputs.get(3).click();
		Thread.sleep(500);
		inputs.get(3).findElement(By.tagName("input")).sendKeys("Biedermann GmbH");
		Thread.sleep(1000);

		driver.findElement(By.xpath("addressBookPageReskin.searchNooshMembButton")).click();
		Thread.sleep(2000);
	...
	public void testAddCategory(String specName, String Quantity)
		...
		Thread.sleep(3000);
		driver.findElement(By.className("MuiFormControl-marginDense")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("1manage");
		Thread.sleep(1000);
		...
		List<WebElement> divs = driver.findElements(By.className("MuiFormControl-marginDense"));
		divs.get(1).click();
		Thread.sleep(1000);

		divs.get(1).findElement(By.tagName("input")).sendKeys("DHs1g1 mgr1");;
		Thread.sleep(1000);
	...
	public void testEditcategory(String specName, String Quantity)
		...
		builder.moveToElement(confMenus.get(3).findElement(By.tagName("li"))).click().perform();
		builder.release();
		Thread.sleep(3000);
	...
	public void testDeleteCategory(String specName, String Quantity)
		...
		Thread.sleep(1000);
		List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		List<WebElement> optionss = confMenus.get(3).findElements(By.tagName("li"));

...
public class TestReskinMarkupAnalysis extends BaseSeleniumTest {
	...
	public void testCopySpecs(String specName, String Quantity)
		...
		driver.findElement(By.xpath("leftToolBar.specsLink")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("specPage.copySpecButton")).click();
		Thread.sleep(3000);
	...
	public void testSellOrderCreate() throws InterruptedException {
		...
		Actions builder = new Actions(driver);
		Thread.sleep(1500);
		builder.moveToElement(driver.findElement(By.className("fa-sticky-note"))).click().perform();
		Thread.sleep(2000);
	
		Thread.sleep(1000);
		driver.findElement(By.xpath("quotePage.quoteLink2")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("orderListPage.detailedMarginTabReskin")).click();
		Thread.sleep(5000);
	...
	public void testDefaultOrderSummary () throws Exception {
		...
		driver.findElement(By.xpath("leftToolBarRekins.sellOrdersLink")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("newProjectPage.markupSummaryLink")).click();
		Thread.sleep(3000);
		String totalMarkup = driver.findElement(By.xpath("orderListPage.totalMarkupField")).getText();
	...
	public void testCreateBuyOrder() throws Exception {
		...
		driver.findElement(By.xpath("leftToolBarReskin.ordersLink")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("orderListPage.quickOrderButtonReskin")).click();
		Thread.sleep(5500);
		...
		driver.findElement(By.id("orderItem1.unitPrice")).click();;
		Thread.sleep(1000);
    ...
    //    executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("orderListPage.markupDetailCheckbox")));
		...
		driver.findElement(By.xpath("orderListPage.detailedMarginCheckbox")).click();
		Thread.sleep(1000); 
	...
	public void testCreateBuyOrderAgain() throws Exception {
		...
		List<WebElement> orderLnks = driver.findElements(By.xpath("leftToolBar.ordersLink"));
	...
	public void testCreateArchiveSpec () throws Exception {
		...
		Actions builder = new Actions(driver);
		builder.moveToElement(driver.findElement(By.xpath("specPage.archiveSpecButton"))).perform();
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		//List<WebElement> confMenus = driver.findElements(By.className("MuiPaper-rounded"));
		builder.moveToElement(driver.findElement(By.xpath("specListPage.archiveSpecButton"))).moveToElement(driver.findElement(By.className("MuiMenuItem-root"))).click().perform();
		Thread.sleep(2000);
		driver.findElement(By.xpath("leftToolBarReskin.ordersLink")).click();
		Thread.sleep(3000);
...
//		Thread.sleep(1500);
		...
		Thread.sleep(5500);
	/*	builder.moveToElement(driver.findElement(By.xpath("orderListPage.detailedMarginTabReskin"))).click().perform();
		Thread.sleep(1000);
		driver.findElement(By.xpath("orderListPage.detailedMarginTabReskin")).click();
		Thread.sleep(2000);
		for (String handle : driver.getWindowHandles()) {
		...
		*/
		JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.xpath("orderListPageReskin.marginAnalysisCheckbox")));
...
/*
		...
		*/
		driver.findElement(By.xpath("newHomePage.quoteLinkReskin")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("quotePage.createQuoteButton")).click();
		Thread.sleep(1000);

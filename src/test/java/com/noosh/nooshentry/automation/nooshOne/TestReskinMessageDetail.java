...
public class TestReskinMessageDetail extends BaseSeleniumTest {
...
/*
	...
	public void testInviteSupplier(String productName1,
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("teamListpage.inviteSupplierButton")).click();
		Thread.sleep(2000);
		Thread.sleep(2000);
	...
	public void testSupplierMessageDetail() throws Exception {
		driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("a")).click();
		Thread.sleep(5000);
		driver.findElement(By.className("MuiGrid-grid-xs-7")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);
		driver.findElement(By.name("back")).click();
		Thread.sleep(4000);
		
		driver.findElement(By.xpath("messagePageReskin.priorityButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiSelect-outlined")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiMenu-list")).findElement(By.tagName("li")).click();
		Thread.sleep(1000);
		
		driver.findElement(By.xpath("messagePageReskin.statusButton")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiSelect-outlined")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiMenu-list")).findElement(By.tagName("li")).click();

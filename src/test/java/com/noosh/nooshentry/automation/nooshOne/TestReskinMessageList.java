...
public class TestReskinMessageList extends BaseSeleniumTest {
...
/*
	...
	public void testInviteTeamMembers(String specName, String Quantity)
			throws Exception, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.xpath("leftToolBar.inviteTeamMembersLink")).click();
		Thread.sleep(3000);
		...
		testSelectContact("Dgb1g1 mgr1", clientInput);
		Thread.sleep(3000);
	//	driver.findElement(By.xpath("teamListpage.assignRolesButton")).click();
		Thread.sleep(1000);
	...
	public void testInviteSupplier(String productName1,
		String projectNameField) throws Exception {
		log.info("Start: Invite member and supplier");
		driver.findElement(By.xpath("leftToolBar.teamLink")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("leftToolBar.inviteSuppliersLink")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("invite.InviteSelectedContacts")).click();
		Thread.sleep(1000);
		WebElement clientInput = driver.findElement(By.xpath("invite.InviteSelectedContacts")).findElement(By.tagName("input"));
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("invite.inviteSuppliersButton")).click();
	...
	public void testCreateMSG() throws InterruptedException {
		...
		inputs.get(0).click();
		Thread.sleep(1000);
		inputs.get(0).findElement(By.tagName("input")).sendKeys("Subject team list");
		Thread.sleep(1000);
		inputs.get(2).click();
		Thread.sleep(1000);
		inputs.get(2).findElement(By.tagName("textarea")).sendKeys("content team list");
		Thread.sleep(1000);
	...
	public void testBuyerCreateMSG() throws InterruptedException {
		...
		Thread.sleep(1000);
		inputs.get(1).findElement(By.tagName("input")).sendKeys("Supplier Subject team list");
		Thread.sleep(1000);
		inputs.get(3).click();
		Thread.sleep(1000);
		inputs.get(3).findElement(By.tagName("textarea")).sendKeys("Supplier content team list");
		Thread.sleep(1000);
	...
	public void testBuyerReplyMSG() throws Exception {
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("messagePage.replyButton")).click();
		//builder.moveToElement(MSGlnk).perform();

		List <WebElement> divs = driver.findElements(By.className("MuiFormControl-marginDense"));
		divs.get(2).click();
		Thread.sleep(1000);
		divs.get(2).findElement(By.tagName("textarea")).sendKeys("Buyer reply MSG");
		Thread.sleep(1000);
	...
	public void testSupplierReplyMSG() throws Exception {
		...
		divs.get(2).click();
		Thread.sleep(1000);
		divs.get(2).findElement(By.tagName("textarea")).sendKeys("Supplier reply MSG");
		Thread.sleep(2000);
		driver.findElement(By.xpath("messagePage.replyMessageButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("myDeskPage.myDeskLink")).click();
	...
	public void testBuyerCheckMSG() throws Exception {
		...
		Thread.sleep(5000);
		driver.findElement(By.className("MuiCollapse-wrapperInner")).findElement(By.tagName("li")).click();
		Thread.sleep(5000);

...
public class TestReskinMyDesk extends BaseSeleniumTest {
	...
	@Test(description = "switch workgroup ")
	@Parameters({ "BuyberWorkGroupNmae" })
    public static void testSwitchWorkGroupsPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		Thread.sleep(1500);
		builder.moveToElement(myDeskLink).moveToElement(driver.findElement(By.linkText("Switch Groups"))).click().perform();
		Thread.sleep(5500);
		driver.findElement(By.className("MuiFormControl-marginDense")).click();
		Thread.sleep(500);
		List <WebElement> inputs = driver.findElements(By.className("MuiInputBase-input"));
		inputs.get(4).click();
		inputs.get(4).sendKeys("apple");
		Thread.sleep(2000);
		driver.findElement(By.className("MuiPaper-elevation8")).findElement(By.tagName("label")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("commonPage.potentialAlertCancelButtons")).click();
		Thread.sleep(5000);
    ...
    public static void testEventListPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("searchManagerPage.pageNum1"));
		Thread.sleep(2000);
    ...
    public static void testTaskListPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		inputs.get(8).click();
		Thread.sleep(500);
		inputs.get(8).findElement(By.tagName("input")).sendKeys("5150615");
		Thread.sleep(1000);
		...
		String taskNum = taskNums.get(1).getText();
		AssertJUnit.assertEquals(taskNum, "Selenium952313264319 (5150615)");
    ...
    public static void testMessageListPage(String BuyberWorkGroupNmae) throws InterruptedException{
		...
		List <WebElement> tabs= driver.findElements(By.className("fa-chevron-down"));
		WebElement myDeskLink = tabs.get(1);
		Actions builder = new Actions(driver);
		Thread.sleep(1500);
		builder.moveToElement(myDeskLink).perform();
		Thread.sleep(1500);
		...
		AssertJUnit.assertEquals(messageName, "Test message");
	
		driver.findElement(By.linkText("test msg")).click();
		Thread.sleep(2000);
	}

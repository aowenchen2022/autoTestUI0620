...
public class TestReskinOrderList extends BaseSeleniumTest {
	...
	@Test(description = "Create Spec - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testViewSellOrder(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		
		driver.findElement(By.className("fa-shopping-cart")).click();
		Thread.sleep(4000);
/*		List<WebElement> printButtons = driver.findElements(By.className("fa-print"));
		...
		List<WebElement> trs = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("tr"));
//		trs.get(1).click();
...
*/
	...
	//	orderLinks.get(0).click();
		Thread.sleep(4000);
		List<WebElement> orderButtons = driver.findElements(By.className("MuiTab-textColorPrimary"));
		orderButtons.get(0).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("orderListPage.sellOrderListReskin")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(5000);
		driver.findElement(By.xpath("orderListPage.buyOrderListReskin")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("orderListPage.lastChanged")).click();
		Thread.sleep(1000);
		...
		Actions builder = new Actions(driver);
		builder.moveToElement(confMenus.get(14)).perform();
		Thread.sleep(2000);
		builder.moveToElement(driver.findElements(By.className("MuiMenuItem-root")).get(0).findElement(By.tagName("span"))).click().perform();
		Thread.sleep(2000);
		driver.navigate().back();
		Thread.sleep(3000);

...
public class TestReskinOrderManager extends BaseSeleniumTest {
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindOrder(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		Thread.sleep(3000);

		List<WebElement> myOrderName = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		orderName = myOrderName.get(0).getText();
        ...
        Thread.sleep(1000);
        driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(orderName);
...
*/
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchSubmittedDate(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchCompletionDate(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchOrderStatus(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;

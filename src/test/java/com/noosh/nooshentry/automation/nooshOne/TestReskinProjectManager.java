...
public class TestReskinProjectManager extends BaseSeleniumTest {
	...
	public void testSearchFindBox(String specName, String Quantity)
		...
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-root")).findElement(By.tagName("input")).sendKeys(projectName);
...
*/
	...
	public  void testOutsourcerFilterCriteria() throws Exception {
		...
		Thread.sleep(2000);
	//	reskinProjManagerUrl = "https://nooshonedemo." + domain +".noosh.com/workspace/projectManager";

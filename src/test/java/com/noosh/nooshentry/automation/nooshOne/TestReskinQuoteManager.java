...
public class TestReskinQuoteManager extends BaseSeleniumTest {
	...
	public void testSearchFindBox(String specName, String Quantity)
		...
		List<WebElement> myQuoteNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		quoteId = myQuoteNums.get(0).getText();
		...
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(quoteId);
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(5000);
		
		
		List<WebElement> quoteNums = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String quoteNum = quoteNums.get(0).getText();
		Assert.assertEquals(quoteNum, quoteId);
...
*/
	...
	public void testSearchSubmitDate(String specName, String Quantity)
    	...
    	List<WebElement> divs1 = driver.findElements(By.className("MuiOutlinedInput-root"));
		executor.executeScript("arguments[0].click();", divs1.get(4));
		Thread.sleep(2000);
		List<WebElement> radios1 = driver.findElements(By.name("radioGroup"));
		executor.executeScript("arguments[0].click();", radios1.get(1));
		Thread.sleep(2000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchQuoteStatus(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
...
*/
	...
	public  void testOutsourcerFilterCriteria() throws Exception {
		...
		Thread.sleep(3000);
	//	reskinProjManagerUrl = "https://nooshonedemo." + domain +".noosh.com/workspace/quoteManager";

...
public class TestReskinRFQsAndQuotesList extends BaseSeleniumTest {
	...
	@Parameters({ "memberUserName", "passwordSP" })
	public void testMemberLogin(String memberUserName, String passwordSP)
			throws InterruptedException {
		log.info("Start: testSPLogin");
		Thread.sleep(1500);
		driver.get(baseUrl);
		...
		Thread.sleep(2000);
		LoginPage loginPage = new LoginPage(driver);
		loginPage.loginUser(memberUserName, passwordSP);
		// spSiteLoginPage = driver.getCurrentUrl();
...
*/
	...
	public void testCreateRfq(String specName, String Quantity)
		...
		Thread.sleep(1500);
		builder.moveToElement(driver.findElement(By.linkText("Create RFQ..."))).click().perform();
		Thread.sleep(1000);
		driver.findElement(By.linkText("Check All")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("continue")).click();
		...
		testSelectContact("Dgb1g1 mem1", userInput);
		Thread.sleep(1000);

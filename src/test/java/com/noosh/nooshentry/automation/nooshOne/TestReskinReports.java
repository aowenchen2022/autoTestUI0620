...
public class TestReskinReports extends BaseSeleniumTest {
	...
	static String specRefNumber;
	static String nooshID;
	...
	@Test(description = "EstimateAnalysis - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testEstimateAnalysis(String productName1, String Quantity)
			throws Exception {
		log.info("Start: testEstimateAnalysis");
		driver.findElement(By.xpath("reportPage.runEstimateAnalysisButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.name("fromDate")).click();
		Thread.sleep(500);
		driver.findElement(By.name("fromDate")).sendKeys("8/31/21");;
		Thread.sleep(1000);

		driver.findElement(By.name("toDate")).click();
		Thread.sleep(500);
		driver.findElement(By.name("toDate")).sendKeys("9/30/21");;
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("groupByField"))).selectByValue("month");
		Thread.sleep(1000);
		driver.findElement(By.xpath("reportPage.runButton")).click();
		Thread.sleep(5000);
		String orderAmount = driver.findElement(By.xpath("reportPage.orderAmountContent")).getText();
		Assert.assertEquals(orderAmount, "$1,204.00");
		
		driver.findElement(By.linkText("2021-09")).click();
		Thread.sleep(5000);
	
		
		
		log.info("End: testEstimateAnalysis");
		
		log.info("--------------------------------------------");
	}
	
	@Test(description = "OrderActivity - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testOrderActivity(String productName1, String Quantity)
			throws Exception {
		log.info("Start: testOrderActivity");
	
		driver.findElement(By.className("glb-nmh-logo")).click();
		Thread.sleep(4000);

		driver.findElement(By.linkText("Reports")).click();
		Thread.sleep(3000);

		driver.findElement(By.xpath("reportPage.runOrderActivityButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.name("fromDate")).click();
		Thread.sleep(500);
		driver.findElement(By.name("fromDate")).sendKeys("8/1/21");;
		Thread.sleep(1000);
		...
		driver.findElement(By.name("toDate")).sendKeys("9/30/21");;
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("filterColumn"))).selectByValue("accept_date");
		Thread.sleep(1000);
		driver.findElement(By.xpath("reportPage.runButton")).click();
		Thread.sleep(5000);
		String orderAmount = driver.findElement(By.xpath("reportPage.grandTotalContent")).getText();
		Assert.assertEquals(orderAmount, "$1,080.00 ");
		
		
		log.info("End: testOrderActivity");
		
		log.info("--------------------------------------------");
	}
	
	
	@Test(description = "SellPriceAnalysis - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSellPriceAnalysis(String productName1, String Quantity)
			throws Exception {
		log.info("Start: testSellPriceAnalysis");
		driver.findElement(By.className("glb-nmh-logo")).click();
		Thread.sleep(4000);
		...
		Thread.sleep(1000);
		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys("sell");;
		Thread.sleep(2000);
		Actions builder = new Actions(driver);
		builder.moveToElement(driver.findElement(By.xpath("reportPage.sellPriceAnalysisConfButton"))).perform();
		Thread.sleep(1000);
		driver.findElement(By.xpath("reportPage.toolTipButton")).click();
		Thread.sleep(3000);
		
		driver.findElement(By.id("link_object_SPA")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("checkbox_SPA.PROJECT_NAME")).click();
		driver.findElement(By.id("checkbox_SPA.PROJECT_NUMBER")).click();
		driver.findElement(By.id("checkbox_SPA.ORDER_REFERENCE")).click();
		driver.findElement(By.id("checkbox_SPA.ORDER_VALUE")).click();
		driver.findElement(By.id("checkbox_SPA.ACCEPT_DATE")).click();
		Thread.sleep(1000);
		
		driver.findElement(By.id("link_object_O")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("checkbox_O.OBJECT_STATUS_ID")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("reportPage.addFiltersButton")).click();
		Thread.sleep(2000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
		}
		new Select(driver.findElement(By.name("filter-column#3"))).selectByValue("O.OBJECT_STATUS_ID");
		Thread.sleep(3000);
		new Select(driver.findElement(By.id("filter-value#1"))).selectByVisibleText("Accepted");
		Thread.sleep(2000);
		driver.findElement(By.linkText("Preview")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("tab_body")).findElement(By.tagName("button")).click();
		Thread.sleep(8000);
		String orderStatus = driver.findElement(By.xpath("reportPage.sellPriceAnalysisPreviewStatus")).getText();
		Assert.assertEquals(orderStatus, "Accepted");

		log.info("End: testSellPriceAnalysis");
	...
	public void testSpecFields(String productName1, String Quantity)
		...
		List<WebElement> inputs = driver.findElements(By.className("MuiGrid-container"));
		inputs.get(10).click();
		Thread.sleep(1000);
		inputs.get(10).findElement(By.tagName("input")).sendKeys(specName);
		Thread.sleep(1000);

		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(5000);
		
		List<WebElement> projectNames = driver.findElement(By.className("MuiTableContainer-root")).findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));
		String projectName = projectNames.get(0).findElement(By.tagName("a")).getText();
		Assert.assertEquals(projectName, projName);
		...
		inputs.get(11).click();
		Thread.sleep(1000);
		inputs.get(11).findElement(By.tagName("input")).sendKeys(specRefNumber);
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(1000);
		
		String projectNameById = projectNames.get(0).findElement(By.tagName("a")).getText();
		Assert.assertEquals(projectNameById, projName);
	...
	/*	
		...
		myOptions.get(0).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("specManagerPage.searchButton")).click();
		Thread.sleep(1000);
	...
	public void testSaveAs(String specName, String Quantity)
		...
		executor.executeScript("window.scrollTo(0,0);");
		Thread.sleep(1000);
		List<WebElement> inputs = driver.findElements(By.className("MuiTextField-root"));
		inputs.get(1).click();
		Thread.sleep(1000);
		inputs.get(1).findElement(By.tagName("input")).sendKeys("TestName");
		Thread.sleep(1000);
		inputs.get(1).findElement(By.tagName("button")).click();
		Thread.sleep(2000);
	...
	//	List<WebElement> svgsAgain = driver.findElements(By.className("MuiSvgIcon-root"));
		Actions builder = new Actions(driver);
		builder.moveToElement(driver.findElement(By.xpath("specManagerPage.toolsIcon"))).perform();
		driver.findElement(By.xpath("specManagerPage.deleteFilterButton")).click();
		Thread.sleep(1000);
	//	driver.findElement(By.xpath("specManagerPage.deleteFilterButton=")).click();
...
*/
	...
	public  void testOutsourcerReportList() throws Exception {
		Thread.sleep(2000);
		driver.findElement(By.linkText("Reports")).click();
		Thread.sleep(6000);

...
public class TestReskinRfeEstimateList extends BaseSeleniumTest {
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		List<WebElement> checkboxes2	 = driver.findElement(By.className("MuiDialog-paperScrollPaper")).findElements(By.className("MuiTableCell-paddingCheckbox"));
		checkboxes2.get(1).click();
		Thread.sleep(1000);
		...
		driver.findElement(By.className("MuiButton-outlinedSizeLarge")).click();
		Thread.sleep(1000);
		List <WebElement> checkboxes3 = driver.findElements(By.className("MuiIconButton-label"));
		Thread.sleep(1000);
		checkboxes3.get(3).click();
		Thread.sleep(1000);
...
/*
    ...
    public static void chooseCalendar(int index) throws InterruptedException{
    	Thread.sleep(1000); 
    	List<WebElement> calendars = driver.findElements(By.tagName("button"));

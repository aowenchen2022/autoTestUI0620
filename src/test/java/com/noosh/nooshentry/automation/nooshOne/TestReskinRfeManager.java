...
public class TestReskinRfeManager extends BaseSeleniumTest {
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindRfe(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");

		List<WebElement> myRFEs = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		rfeName = myRFEs.get(0).getText();
		System.out.print(rfeName);
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiFormControl-marginDense")));
		
		Thread.sleep(1000);

		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(rfeName);
		Thread.sleep(1000);
		...
		Assert.assertEquals(actualRfeName, rfeName);
	...
	public void testSearchDueDate(String specName, String Quantity)
		...
		executor.executeScript("arguments[0].click();", divs1.get(5));
		Thread.sleep(2000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchRfeStatus(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
...
*/
	...
	public  void testOutsourcerFilterCriteria() throws Exception {
		...
		Thread.sleep(2000);
	//	reskinProjManagerUrl = "https://nooshonedemo." + domain +".noosh.com/workspace/RFEsManager";

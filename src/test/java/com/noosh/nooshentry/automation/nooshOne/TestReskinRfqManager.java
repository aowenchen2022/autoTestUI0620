...
public class TestReskinRfqManager extends BaseSeleniumTest {
	...
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchFindRfq(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");

		List<WebElement> myRFQs = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		rfqName = myRFQs.get(0).getText();
		System.out.print(rfqName);
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", driver.findElement(By.className("MuiFormControl-marginDense")));
		
		Thread.sleep(1000);

		driver.findElement(By.className("MuiFormControl-marginDense")).findElement(By.tagName("input")).sendKeys(rfqName);
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(5000);
		
		List<WebElement> actualRfqNames = driver.findElement(By.className("MuiTableBody-root")).findElements(By.tagName("a"));
		String actualRfqName = actualRfqNames.get(0).getText();
		Assert.assertEquals(actualRfqName, rfqName);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchOrder(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");

		List<WebElement> myOrderName = driver.findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));
		orderName = myOrderName.get(5).getText();
		List<WebElement> fields = driver.findElements(By.className("MuiOutlinedInput-root"));

        JavascriptExecutor executor = (JavascriptExecutor) driver;
        executor.executeScript("arguments[0].click();", fields.get(1));
		
		Thread.sleep(1000);
		fields.get(1).findElement(By.tagName("input")).sendKeys(orderName);
		Thread.sleep(1000);
		List<WebElement> svg = driver.findElements(By.className("MuiSvgIcon-root"));
	  //  executor.executeScript("arguments[0].click();", svg.get(8));

		svg.get(5).click();
		Thread.sleep(5000);
		
		List<WebElement> orderNameResults = driver.findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));
		String orderNameResult = orderNameResults.get(5).getText();
		Assert.assertEquals(orderNameResult, orderName);
	}
	
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchSubmitDate(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
		...
		executor.executeScript("arguments[0].click();", divs.get(6));
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		List<WebElement> options = driver.findElement(By.className("MuiMenu-list")).findElements(By.className("MuiTouchRipple-root"));
		executor.executeScript("arguments[0].click();", options.get(3));
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchDueDate(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
		...
		executor.executeScript("arguments[0].click();", divs1.get(7));
		Thread.sleep(2000);
		...
		driver.findElement(By.className("MuiFormGroup-root")).findElement(By.className("MuiSelect-select")).click();
		Thread.sleep(1000);
		List<WebElement> options1 = driver.findElement(By.className("MuiMenu-list")).findElements(By.className("MuiTouchRipple-root"));
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSearchRfqStatus(String specName, String Quantity)
			throws InterruptedException, AWTException {
		log.info("Start: testSPcreateSpecWizard");
		//create date:
        JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	public void testSearchAllAccessible(String specName, String Quantity)
		...
		Assert.assertEquals(actualRfeName, rfqName);
	}
...
*/
	...
	public  void testOutsourcerFilterCriteria() throws Exception {
		...
		Thread.sleep(3000);
//		reskinProjManagerUrl = "https://nooshonedemo." + domain +".noosh.com/workspace/rfqsManager";
//		driver.get(reskinProjManagerUrl);
		Thread.sleep(5000);

...
public class TestReskinSpecManager extends BaseSeleniumTest {
	...
	public void testProjectFields(String productName1, String Quantity)
		...
		List<WebElement> tables = driver.findElements(By.id("resultTableWrapper"));
		List<WebElement> myProj = tables.get(2).findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));
		projName = myProj.get(0).findElement(By.tagName("a")).getText();
		specName = myProj.get(4).findElement(By.tagName("a")).getText();
		nooshID = myProj.get(1).getText();
		specRefNumber = myProj.get(5).getText();
		System.out.println(projName);
		System.out.println(specName);
		System.out.println(nooshID);
		System.out.println(specRefNumber);
		...
		inputs.get(7).click();
		Thread.sleep(1000);
		inputs.get(7).findElement(By.tagName("input")).sendKeys(projName);
		Thread.sleep(1000);
	...
	//	driver.findElement(By.className("MuiGrid-justify-xs-space-between")).findElement(By.tagName("button")).click();
		...
		List<WebElement> projectNames = tables.get(2).findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));
		...
		inputs.get(8).click();
		Thread.sleep(1000);
		inputs.get(8).findElement(By.tagName("input")).sendKeys(nooshID);
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(1000);
		
		String projectNameById = projectNames.get(1).getText();
		Assert.assertEquals(projectNameById, nooshID);
		...
		inputs.get(9).click();
		Thread.sleep(1000);
		inputs.get(9).findElement(By.tagName("input")).sendKeys(nooshID);
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(1000);
		
		String projectNameByNum = projectNames.get(2).getText();
		Assert.assertEquals(projectNameByNum, nooshID);
		...
		inputs.get(11).click();
		Thread.sleep(1000);
		inputs.get(11).findElement(By.tagName("input")).sendKeys("Apple");
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(1000);
		
		String projectNameByClient = projectNames.get(0).findElement(By.tagName("a")).getText();
		Assert.assertEquals(projectNameByClient, projName);
	...
	public void testSpecFields(String productName1, String Quantity)
		...
		inputs.get(12).click();
		Thread.sleep(1000);
		inputs.get(12).findElement(By.tagName("input")).sendKeys(specName);
		Thread.sleep(1000);
		...
		inputs.get(13).click();
		Thread.sleep(1000);
		inputs.get(13).findElement(By.tagName("input")).sendKeys(specRefNumber);
		Thread.sleep(1000);
		driver.findElement(By.xpath("projectManagerPage.searchButton")).click();
		Thread.sleep(3000);
		for (String handle : driver.getWindowHandles()) {
		...
		List<WebElement> tablesAgain = driver.findElements(By.id("resultTableWrapper"));
		List<WebElement> projectNames2 = tablesAgain.get(2).findElement(By.className("MuiTableBody-root")).findElements(By.className("MuiTableCell-root"));

		String projectNameById = projectNames2.get(0).findElement(By.tagName("a")).getText();
	...
	public void testSaveAs(String specName, String Quantity)
		...
		inputs.get(2).click();
		Thread.sleep(1000);
		inputs.get(2).findElement(By.tagName("input")).sendKeys("TestName");
		Thread.sleep(1000);
		inputs.get(2).findElement(By.tagName("button")).click();
		Thread.sleep(2000);
		String savedName = driver.findElement(By.className("MuiSelect-select")).getText();
	...
	//	driver.findElement(By.xpath("specManagerPage.deleteFilterButton=")).click();
		...
		Thread.sleep(2000);
		String noneName = driver.findElement(By.className("MuiSelect-select")).getText();

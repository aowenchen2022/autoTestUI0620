...
public class TestReskinSupplierRating extends BaseSeleniumTest {
...
//		driver.findElement(By.xpath("rfePage.notifySuppliersButton")).click();
	...
	*/
	...
	public void testCreateBuyOrder() throws Exception {
		...
		Thread.sleep(4000);
		driver.findElement(By.className("MuiRadio-root")).findElement(By.tagName("input")).click();
		Thread.sleep(1000);
	...
	public void testSupplierOrderAcceptance() throws Exception {
		...
		driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("a")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("buyOrderDetailPage.supplierRatingButton")).click();
		Thread.sleep(6000);
		log.info("--------------------------------------------");
	}
	...
	@Test(description = "Create Spec - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSupplierRating(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSupplierRating");
		...
		radioButtons.get(8).click();
		radioButtons.get(12).click();
		radioButtons.get(16).click();
		radioButtons.get(20).click();
		Thread.sleep(2000);

		driver.findElement(By.xpath("supplierRatingPage.completeRatingButton")).click();
		Thread.sleep(5000);

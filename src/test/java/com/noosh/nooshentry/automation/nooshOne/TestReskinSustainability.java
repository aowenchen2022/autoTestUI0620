...
public class TestReskinSustainability extends BaseSeleniumTest {
	...
	public void testCreateSpecs1(String specName, String Quantity)
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("specPage.printedProductRadio")).click();
		Thread.sleep(1000);
		List <WebElement> buttons = driver.findElements(By.className("MuiButton-containedPrimary"));
		buttons.get(1).click();
		Thread.sleep(2000);

		driver.findElement(By.id("name")).sendKeys("SpecSus01");
		Thread.sleep(1000);
		...
		driver.findElement(By.id("STOCK_USED_AS")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("STOCK_USED_AS")).sendKeys("stock");
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("WEIGHT"))).selectByIndex(1);
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("STOCK_TYPE"))).selectByIndex(1);
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("TEXTURE"))).selectByIndex(1);
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("FINISH"))).selectByIndex(1);
		Thread.sleep(1000);
		driver.findElement(By.id("SURF1_BLEEDS")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("addBottom")).click();
		Thread.sleep(1000);
	...
	public void testCreateRFE(String specName, String Quantity)
		...
		rfeName = projectName;
		 //driver.findElement(By.className("glb-wdgt-activities-list")).findElement(By.tagName("a")).click();
		driver.findElement(By.xpath("leftToolBar.estimateLink")).click();
		Thread.sleep(4000);
		List<WebElement> buttons = driver.findElements(By.className("MuiButton-containedPrimary"));
		buttons.get(1).click();
		Thread.sleep(4000);
	...
	public void testSupplierEstCreate() throws InterruptedException, AWTException {
		...
		Thread.sleep(1000);
		driver.findElement(By.name("@est_item_-1.PAP_AMOUNT1_num")).click();
		Thread.sleep(1000);
		driver.findElement(By.name("@est_item_-1.PAP_AMOUNT1_num")).sendKeys("100");
		Thread.sleep(1000);
		driver.findElement(By.name("@est_item_-1.PAP_RECYCLE1_num")).click();
		Thread.sleep(1000);
		driver.findElement(By.name("@est_item_-1.PAP_RECYCLE1_num")).sendKeys("50");
		Thread.sleep(1000);
		driver.findElement(By.xpath("estimatePage.calculateImpactButton")).click();
		Thread.sleep(2000);
		String totalEnergy= driver.findElement(By.id("totalEnergyResult")).getText();
		AssertJUnit.assertEquals(totalEnergy, "0.997 million BTUs");
	...
	public void testCreateBuyOrder() throws Exception {
		...
		driver.findElement(By.className("glb-wdgt-estimates-rfe-title")).findElement(By.tagName("a")).click();
		Thread.sleep(4000);
		WebElement treeLink = driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("img"));

		Actions builder = new Actions(driver);
		builder.moveToElement(treeLink).perform();
		Thread.sleep(1500);
		builder.moveToElement(treeLink).click().perform();
		Thread.sleep(1000);
		treeLink.click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.className("close_1")).click();
		Thread.sleep(1000);
		String paperInfo = driver.findElement(By.xpath("orderPage.paperInfo")).getText();
		System.out.print(paperInfo);
		AssertJUnit.assertEquals(paperInfo, "100 pounds");
	...
	public void testViewOrderDetail() throws Exception {
		...
		driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("a")).click();
		Thread.sleep(4000);
		driver.findElement(By.xpath("orderPage.paperInfoInDetail")).click();
		Thread.sleep(1000);
		String totalEnergy = driver.findElement(By.xpath("orderPage.paperInfoInSpec")).getText();
	...
	@Test(description = "Create order - step 8")
	public void testCreateQuickOrder() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.id("orderItem1.unitPrice")).sendKeys("2000");
	...
	public void testSupplierOrderAcceptance() throws Exception {
		...
		.build().perform();
		Thread.sleep(3000);
		driver.findElement(By.xpath("orderPage.editOrderButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("@orderItem1.PAP_AMOUNT1_num")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("@orderItem1.PAP_AMOUNT1_num")).sendKeys("200");
		Thread.sleep(1000);
		driver.findElement(By.id("@orderItem1.PAP_RECYCLE1_num")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("@orderItem1.PAP_RECYCLE1_num")).sendKeys("20");
		Thread.sleep(1000);
		driver.findElement(By.xpath("estimatePage.calculateImpactButton")).click();
		Thread.sleep(2000);
		String totalEnergy= driver.findElement(By.id("totalEnergyResult")).getText();
		AssertJUnit.assertEquals(totalEnergy, "2.27 million BTUs");
		driver.findElement(By.className("ui-dialog-titlebar-close")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("save_and_accept")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		String totalEnergyOrderPage= driver.findElement(By.xpath("orderPage.paperInfoInSpec")).getText();
		AssertJUnit.assertEquals(totalEnergyOrderPage, "2.27 million BTUs");
...
*/
	...
	public  void testOutsourcerOrderAcceptance() throws Exception {
...
/*
    ...
    public static void scrollToView(WebElement e) throws Exception{

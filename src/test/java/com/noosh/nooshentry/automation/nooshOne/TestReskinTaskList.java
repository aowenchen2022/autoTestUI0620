...
public class TestReskinTaskList extends BaseSeleniumTest {
    ...
    public void testAttachProject() throws InterruptedException{
		 driver.findElement(By.xpath("newHomePage.homeLink")).click();
		 Thread.sleep(3000);

		 driver.findElement(By.xpath("newHomePage.AttachLink")).click();
		 Thread.sleep(1000);
		 driver.findElement(By.id("nplSection_body")).findElement(By.id("searchString")).sendKeys("Selenium");
		 Thread.sleep(1000);
		 ...
		 Thread.sleep(1000);
		 driver.findElement(By.linkText(attachedProjectName)).isDisplayed();
	}
	...
	public void testInlineEdits(String specName, String Quantity)
			throws InterruptedException, AWTException {
		driver.findElement(By.xpath("taskPage.deleteTaskIcon")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("commonPage.potentialAlertNoButtons")).click();
		Thread.sleep(1000);
		driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("a")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("taskPage.plannedHourCheckbox")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("revisedStartDate")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("revisedStartDate")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("revisedStartDate")).sendKeys("6/6/22");
		Thread.sleep(1000);
		driver.findElement(By.id("revisedEndDate")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("revisedEndDate")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("revisedEndDate")).sendKeys("6/8/22");
		Thread.sleep(1000);
		driver.findElement(By.id("update_task")).click();
		Thread.sleep(2000);
		String planEndDate = driver.findElement(By.xpath("taskPage.planEndDateValue")).getText();
		Assert.assertEquals(planEndDate, "6/8/22");
		}
	...
	public void testCreateTask1(String specName, String Quantity)
		...
		driver.findElement(By.xpath("leftToolBar.taskLink")).click();
		Thread.sleep(4000);
		List<WebElement> buttons = driver.findElements(By.className("MuiButton-text"));
		buttons.get(2).click();
		Thread.sleep(5000);

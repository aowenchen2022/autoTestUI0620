...
public class TestReskinTeamList extends BaseSeleniumTest {
	...
	public void testSearchFindProject(String specName, String Quantity)
		...
		List<WebElement> search = driver.findElements(By.className("glb-search-outer"));
		search.get(0).click();
		Thread.sleep(500);
		search.get(0).findElement(By.tagName("input")).sendKeys("5114699");
		Thread.sleep(3000);
		search.get(0).findElement(By.tagName("input")).sendKeys(Keys.ENTER);
		Thread.sleep(3000);
		driver.findElement(By.className("MuiTableBody-root")).findElement(By.tagName("em")).click();
		Thread.sleep(5000);
	...
	public void testCogfMenu(String specName, String Quantity)
		...
		confMenus.get(0).findElement(By.tagName("li")).click();
		Thread.sleep(1000);
		new Select(driver.findElement(By.id("TM_ROLE0"))).selectByIndex(1);
		Thread.sleep(1000);
	...
	public void testInviteTeamMembers(String specName, String Quantity)
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("teamListpage.inviteTeamMemberButton")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("commonPage.potentialAlertCancelButtons")).click();
		Thread.sleep(3000);

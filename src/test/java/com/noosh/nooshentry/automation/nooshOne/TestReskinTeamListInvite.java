...
public class TestReskinTeamListInvite extends BaseSeleniumTest {
	...
	@Test(description = "click global 'create project' - step 2.1")
	public void testClickGlbCreateProjAgain()
			throws InterruptedException {
		log.info("Start: testClickGlbCreateProj");
		testClickGlbCreateProj();
		log.info("End: testClickGlbCreateProj");
		log.info("--------------------------------------------");
	}
	...
	@Test(description = "Input project name - step 2.2")
	@Parameters({ "productName1", "projectNameField" })
	public void testInputProjectNameAgain(String productName1,
		String projectNameField) throws InterruptedException {
	...
	@Test(description = "Outsourcer select Client - step 2.4 ")
	public static void testSelectContacts(String username) throws Exception{
		driver.findElement(By.className("userInput")).click();
		Thread.sleep(1000);

		driver.findElement(By.className("userInput")).findElement(By.tagName("input")).sendKeys(username);
		Thread.sleep(2000);
		driver.findElement(By.className("workgroupName")).click();
	...
	//	new Select(driver.findElement(By.name("clientId"))).selectByValue("5011944");;
		Thread.sleep(3000);
	...
	@Test(description = "Create Project - step 2.3")
	@Parameters({ "productName1", "projectNameField" })
	public void testCreateProjectWizardAgain(String productName1,
			String projectNameField) throws Exception {
		log.info("Start: testCreateProjectProjectWizard");
	//	new Select(driver.findElement(By.name("clientId"))).selectByValue("5011944");;
		Thread.sleep(3000);
		...
		//new Select(driver.findElement(By.name("@Division_str"))).selectByIndex(1);
		WebElement clientInput = driver.findElement(By.className("contactSelectorContainer")).findElement(By.tagName("input"));
	//	testSelectContact("Dgb1g1", clientInput);
	//	driver.findElement(By.className("ui-menu-item")).click();
		Thread.sleep(1000);
		for (String handle : driver.getWindowHandles()) {
			driver.switchTo().window(handle);
	...
	public void testInviteTeamMembers(String specName, String Quantity)
		...
		testSelectContact("Dgs1g1 mem1", clientInput);
		Thread.sleep(3000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testInviteTeamMembersCustomization (String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		driver.findElement(By.className("fa-users")).click();
		Thread.sleep(4000);
		...
		Thread.sleep(1000);
		WebElement clientInput = driver.findElement(By.xpath("invite.InviteSelectedContacts")).findElement(By.tagName("input"));
		testSelectContact("Valeria", clientInput);
		Thread.sleep(2000);

		Thread.sleep(1000);
		driver.findElement(By.xpath("invite.inviteSendInvitationButton")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("teamListpage.memebrsLink")).click();
		Thread.sleep(1000);
	...
	public void testInviteClients(String specName, String Quantity)
		...
		//driver.findElement(By.className("fa-users")).click();
		Thread.sleep(3000);
		List<WebElement> buttons = driver.findElements(By.className("MuiButton-outlined"));
		...
		Thread.sleep(1000);
		WebElement clientInput = driver.findElement(By.xpath("invite.InviteSelectedContacts")).findElement(By.tagName("input"));
		testSelectContact("Dgb1g1 mem1", clientInput);
		Thread.sleep(2000);
		List <WebElement> myButtons = driver.findElements(By.className("MuiButton-containedPrimary"));
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testSupplierInviteTeamMembers(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		//selectWorkGroups("appleTalk");
		driver.findElement(By.className("glb-wdgt-activities-list")).findElement(By.tagName("a")).click();
		Thread.sleep(4000);
		driver.findElement(By.className("fa-users")).click();
		Thread.sleep(3000);
	...
	@Test(description = "Search Find Box - step 4")
	@Parameters({ "productName1", "projectNameField" })
	public void testBuyerInviteTeamMembers(String specName, String Quantity)
			throws Exception {
		log.info("Start: testSPcreateSpecWizard");
		
		driver.findElement(By.className("table-responsive")).findElement(By.tagName("a")).click();
		Thread.sleep(2000);
		driver.findElement(By.className("fa-users")).click();
		Thread.sleep(5000);
		List<WebElement> buttons = driver.findElements(By.className("MuiButton-containedPrimary"));
		...
		Thread.sleep(1000);
		WebElement clientInput = driver.findElement(By.xpath("invite.InviteSelectedContacts")).findElement(By.tagName("input"));
		testSelectContact("DHs1g1 mgr1", clientInput);
		Thread.sleep(2000);
		List <WebElement> myButtons = driver.findElements(By.className("MuiButton-containedPrimary"));
		myButtons.get(1).click();
...
*/
    ...
    public static void selectWorkGroups(String workgroups) throws InterruptedException{
    	...
    	WebElement adminLnk = driver.findElement(By.className("glb-nmh-workgroups"));
    	Actions builder = new Actions(driver);
    	builder.moveToElement(adminLnk).perform();
    	Thread.sleep(1500);
    	builder.moveToElement(adminLnk).moveToElement(driver.findElement(By.xpath(workgroups))).click()
    	.build().perform();
    ...
    public static void selectMyGroup() throws InterruptedException{
    	//Hover over My Desk>Summary> click on Switch workgroups
    	WebElement adminLnk = driver.findElement(By.className("glb-nmh-profile-default"));

...
public class TestRfeManager extends BaseSeleniumTest {
	...
	public void testSearchFindRfe(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys(rfeName);
		Thread.sleep(1000);

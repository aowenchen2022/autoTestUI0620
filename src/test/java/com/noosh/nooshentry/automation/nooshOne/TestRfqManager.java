...
public class TestRfqManager extends BaseSeleniumTest {
	...
	public void testSearchFindRfq(String specName, String Quantity)
		...
		driver.findElement(By.className("MuiOutlinedInput-root")).findElement(By.tagName("input")).sendKeys(rfqName);
		Thread.sleep(1000);

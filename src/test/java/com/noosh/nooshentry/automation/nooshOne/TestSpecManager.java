...
public class TestSpecManager extends BaseSeleniumTest {
	...
	//	driver.findElement(By.className("MuiGrid-justify-xs-space-between")).findElement(By.tagName("button")).click();
		...
		inputs.get(4).click();
		Thread.sleep(1000);
		inputs.get(4).findElement(By.tagName("input")).sendKeys("5148194");
		Thread.sleep(1000);
		driver.findElement(By.xpath("specManagerPage.searchButton")).click();
		Thread.sleep(1000);
		...
		inputs.get(6).click();
		Thread.sleep(1000);
		inputs.get(6).findElement(By.tagName("input")).sendKeys("5148194");
		Thread.sleep(1000);
		driver.findElement(By.xpath("specManagerPage.searchButton")).click();
		Thread.sleep(1000);
		...
		inputs.get(9).click();
		Thread.sleep(1000);
		inputs.get(9).findElement(By.tagName("input")).sendKeys("Apple");
		Thread.sleep(1000);
		driver.findElement(By.xpath("specManagerPage.searchButton")).click();
		Thread.sleep(1000);
		...
		actions.moveToElement(svg.get(13));
		actions.click();
	...
	public void testSpecFields(String productName1, String Quantity)
		...
		inputs.get(15).click();
		Thread.sleep(1000);
		inputs.get(15).findElement(By.tagName("input")).sendKeys("5149315");
		Thread.sleep(1000);
		driver.findElement(By.xpath("specManagerPage.searchButton")).click();
		Thread.sleep(1000);

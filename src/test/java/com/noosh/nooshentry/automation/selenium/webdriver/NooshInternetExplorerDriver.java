...
public class NooshInternetExplorerDriver extends InternetExplorerDriver implements NooshWebDriver{

	public NooshInternetExplorerDriver() {
		super();
	}

	public NooshInternetExplorerDriver(Capabilities capabilities) {
		super(capabilities);
	}
